...
main(int argc, char *argv[])
{
  ...
  57:	e8 4f 03 00 00       	call   3ab <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 1a 03 00 00       	call   383 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 78 04 00 00       	call   4f0 <printf>
      exit();
  78:	e8 06 03 00 00       	call   383 <exit>
    cat(0);
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 f3 02 00 00       	call   3a3 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 d1 02 00 00       	call   39b <read>
  ...
  e6:	e8 05 04 00 00       	call   4f0 <printf>
      exit();
  eb:	e8 93 02 00 00       	call   383 <exit>
  ...
  f9:	e8 f2 03 00 00       	call   4f0 <printf>
    exit();
  fe:	e8 80 02 00 00       	call   383 <exit>
