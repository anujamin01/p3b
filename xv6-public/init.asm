...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  f7:	a1 34 0d 00 00       	mov    0xd34,%eax
  fc:	01 c0                	add    %eax,%eax
  fe:	50                   	push   %eax
  ff:	e8 2c 07 00 00       	call   830 <malloc>
  void* original = stack;
  //Check page alignmenet
  if((uint)stack % PGSIZE != 0){
 104:	8b 0d 34 0d 00 00    	mov    0xd34,%ecx
 ...
 115:	01 d9                	add    %ebx,%ecx
 117:	29 d0                	sub    %edx,%eax
 119:	01 d8                	add    %ebx,%eax
 11b:	85 d2                	test   %edx,%edx
 11d:	0f 45 c8             	cmovne %eax,%ecx
  }
  else{
    stack += PGSIZE;
  }
 ...
 122:	eb 0c                	jmp    130 <thread_create+0x40>
 124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 128:	83 c2 01             	add    $0x1,%edx
 12b:	83 fa 40             	cmp    $0x40,%edx
 12e:	74 2f                	je     15f <thread_create+0x6f>
    if(!stack_addrs[i] && !inUse[i]){ //TODO try and change this.
 130:	8b 04 95 40 0f 00 00 	mov    0xf40(,%edx,4),%eax
 137:	85 c0                	test   %eax,%eax
 139:	75 ed                	jne    128 <thread_create+0x38>
 13b:	8b 04 95 40 0d 00 00 	mov    0xd40(,%edx,4),%eax
 142:	85 c0                	test   %eax,%eax
 144:	75 e2                	jne    128 <thread_create+0x38>
      inUse[i] = 1;
 146:	c7 04 95 40 0d 00 00 	movl   $0x1,0xd40(,%edx,4)
 14d:	01 00 00 00 
      malloc_addrs[i] = original;
 151:	89 1c 95 40 0e 00 00 	mov    %ebx,0xe40(,%edx,4)
      stack_addrs[i] = stack;
 158:	89 0c 95 40 0f 00 00 	mov    %ecx,0xf40(,%edx,4)
      break;
    }
  }
 ...
 169:	e8 c5 03 00 00       	call   533 <clone>
...
{
 189:	83 ec 30             	sub    $0x30,%esp
  int threadId = join(&stackAddr);
 18c:	50                   	push   %eax
 18d:	e8 a9 03 00 00       	call   53b <join>
 ...
 1a6:	74 4c                	je     1f4 <thread_join+0x74>
    if (inUse[i] == 1 && stack_addrs[i] == stackAddr){ // if joined freer the stack 
 1a8:	83 3c 9d 40 0d 00 00 	cmpl   $0x1,0xd40(,%ebx,4)
 1af:	01 
 1b0:	75 ee                	jne    1a0 <thread_join+0x20>
 1b2:	39 14 9d 40 0f 00 00 	cmp    %edx,0xf40(,%ebx,4)
 1b9:	75 e5                	jne    1a0 <thread_join+0x20>
      free(malloc_addrs[i]);
 1bb:	83 ec 0c             	sub    $0xc,%esp
 1be:	ff 34 9d 40 0e 00 00 	push   0xe40(,%ebx,4)
 1c5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 1c8:	e8 d3 05 00 00       	call   7a0 <free>
      malloc_addrs[i] = 0;
      stack_addrs[i] = 0;
      inUse[i] = 0;
      break;
 ...
 1d0:	83 c4 10             	add    $0x10,%esp
      malloc_addrs[i] = 0;
 1d3:	c7 04 9d 40 0e 00 00 	movl   $0x0,0xe40(,%ebx,4)
 1da:	00 00 00 00 
      stack_addrs[i] = 0;
 1de:	c7 04 9d 40 0f 00 00 	movl   $0x0,0xf40(,%ebx,4)
 1e5:	00 00 00 00 
      inUse[i] = 0;
 1e9:	c7 04 9d 40 0d 00 00 	movl   $0x0,0xd40(,%ebx,4)
 1f0:	00 00 00 00 
    }
  }
  return threadId; 
...
free(void *ap)
{
 ...
 7a1:	a1 40 10 00 00       	mov    0x1040,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 40 10 00 00    	mov    %edx,0x1040
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 40 10 00 00    	mov    %edx,0x1040
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d 40 10 00 00    	mov    0x1040,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 87f:	73 4f                	jae    8d0 <malloc+0xa0>
    ...
    if(p == freep)
 881:	8b 3d 40 10 00 00    	mov    0x1040,%edi
 ...
 8aa:	e8 f1 fe ff ff       	call   7a0 <free>
  return freep;
 8af:	8b 15 40 10 00 00    	mov    0x1040,%edx
 ...
 8dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8df:	89 15 40 10 00 00    	mov    %edx,0x1040
}
 ...
 8ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8f0:	c7 05 40 10 00 00 44 	movl   $0x1044,0x1040
 8f7:	10 00 00 
    base.s.size = 0;
 8fa:	bf 44 10 00 00       	mov    $0x1044,%edi
    base.s.ptr = freep = prevp = &base;
 8ff:	c7 05 44 10 00 00 44 	movl   $0x1044,0x1044
 906:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 909:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 90b:	c7 05 48 10 00 00 00 	movl   $0x0,0x1048
 912:	00 00 00 
    if(p->s.size >= nunits){
