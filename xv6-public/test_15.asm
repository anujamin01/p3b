...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 8f 05 00 00       	call   5a3 <getpid>
  ...
  1c:	a3 28 0e 00 00       	mov    %eax,0xe28
   lock_init(&lock);
  21:	e8 6a 02 00 00       	call   290 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 08 0e 00 00       	mov    0xe08,%eax
  ...
  40:	a1 08 0e 00 00       	mov    0xe08,%eax
  ...
  7a:	68 ca 09 00 00       	push   $0x9ca
   }

   for (i = 0; i < num_threads; i++) {
      int join_pid = thread_join();
      assert(join_pid > 0);
  7f:	68 d9 09 00 00       	push   $0x9d9
  84:	6a 01                	push   $0x1
  86:	e8 05 06 00 00       	call   690 <printf>
  8b:	5a                   	pop    %edx
  8c:	59                   	pop    %ecx
  8d:	68 ed 09 00 00       	push   $0x9ed
  92:	6a 01                	push   $0x1
  94:	e8 f7 05 00 00       	call   690 <printf>
  99:	5b                   	pop    %ebx
  9a:	ff 35 28 0e 00 00    	push   0xe28
  a0:	e8 ae 04 00 00       	call   553 <kill>
  a5:	e8 79 04 00 00       	call   523 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 08 0e 00 00       	mov    0xe08,%eax
  ...
  e3:	68 fa 09 00 00       	push   $0x9fa
  e8:	eb 95                	jmp    7f <main+0x7f>
   }

   assert(global == num_threads * loops);
  ea:	0f af 05 04 0e 00 00 	imul   0xe04,%eax
 ...
 105:	6a 01                	push   $0x1
 107:	e8 84 05 00 00       	call   690 <printf>
 10c:	83 c4 0c             	add    $0xc,%esp
 10f:	68 07 0a 00 00       	push   $0xa07
 114:	e9 66 ff ff ff       	jmp    7f <main+0x7f>

   printf(1, "TEST PASSED\n");
 119:	50                   	push   %eax
 11a:	50                   	push   %eax
 11b:	68 25 0a 00 00       	push   $0xa25
 120:	6a 01                	push   $0x1
 122:	e8 69 05 00 00       	call   690 <printf>
   exit();
 127:	e8 f7 03 00 00       	call   523 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 134:	83 ec 04             	sub    $0x4,%esp
   int i, j, tmp;
   for (i = 0; i < loops; i++) {
 137:	a1 04 0e 00 00       	mov    0xe04,%eax
 ...
 153:	e8 48 01 00 00       	call   2a0 <lock_acquire>
      tmp = global;
 ...
 15f:	83 05 24 0e 00 00 01 	addl   $0x1,0xe24
      lock_release(&lock);
 166:	e8 55 01 00 00       	call   2c0 <lock_release>
   for (i = 0; i < loops; i++) {
 16b:	83 c4 10             	add    $0x10,%esp
 16e:	39 1d 04 0e 00 00    	cmp    %ebx,0xe04
 174:	7f d2                	jg     148 <worker+0x18>
   }
   exit();
 176:	e8 a8 03 00 00       	call   523 <exit>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 187:	a1 0c 0e 00 00       	mov    0xe0c,%eax
 ...
 194:	8b 0d 0c 0e 00 00    	mov    0xe0c,%ecx
 ...
 1c0:	8b 04 95 40 10 00 00 	mov    0x1040(,%edx,4),%eax
 1c7:	85 c0                	test   %eax,%eax
 1c9:	75 ed                	jne    1b8 <thread_create+0x38>
 1cb:	8b 04 95 40 0e 00 00 	mov    0xe40(,%edx,4),%eax
 1d2:	85 c0                	test   %eax,%eax
 1d4:	75 e2                	jne    1b8 <thread_create+0x38>
      inUse[i] = 1;
 1d6:	c7 04 95 40 0e 00 00 	movl   $0x1,0xe40(,%edx,4)
 1dd:	01 00 00 00 
      malloc_addrs[i] = original;
 1e1:	89 1c 95 40 0f 00 00 	mov    %ebx,0xf40(,%edx,4)
      stack_addrs[i] = stack;
 1e8:	89 0c 95 40 10 00 00 	mov    %ecx,0x1040(,%edx,4)
      break;
    }
  }
 ...
 216:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 242:	39 14 9d 40 10 00 00 	cmp    %edx,0x1040(,%ebx,4)
 249:	75 e5                	jne    230 <thread_join+0x20>
      free(malloc_addrs[i]);
 24b:	83 ec 0c             	sub    $0xc,%esp
 24e:	ff 34 9d 40 0f 00 00 	push   0xf40(,%ebx,4)
 ...
 260:	83 c4 10             	add    $0x10,%esp
      malloc_addrs[i] = 0;
 263:	c7 04 9d 40 0f 00 00 	movl   $0x0,0xf40(,%ebx,4)
 26a:	00 00 00 00 
      stack_addrs[i] = 0;
 26e:	c7 04 9d 40 10 00 00 	movl   $0x0,0x1040(,%ebx,4)
 275:	00 00 00 00 
      inUse[i] = 0;
 279:	c7 04 9d 40 0e 00 00 	movl   $0x0,0xe40(,%ebx,4)
 280:	00 00 00 00 
    }
  }
  return threadId; 
 ...
 5ec:	89 d1                	mov    %edx,%ecx
{
 ...
 619:	0f b6 92 94 0a 00 00 	movzbl 0xa94(%edx),%edx
 ...
 699:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 709:	ff 24 85 3c 0a 00 00 	jmp    *0xa3c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 817:	90                   	nop
          s = "(null)";
 818:	ba 32 0a 00 00       	mov    $0xa32,%edx
        while(*s != 0){
