...
00000010 <printf>:
{
  ...
  write(fd, s, strlen(s));
  1a:	53                   	push   %ebx
  1b:	e8 b0 01 00 00       	call   1d0 <strlen>
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  4e:	e8 7d 01 00 00       	call   1d0 <strlen>
  ...
  b0:	e8 1b 01 00 00       	call   1d0 <strlen>
  ...
  d7:	e8 f4 00 00 00       	call   1d0 <strlen>
