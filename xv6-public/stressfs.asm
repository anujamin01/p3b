...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 147:	a1 5c 0d 00 00       	mov    0xd5c,%eax
 14c:	01 c0                	add    %eax,%eax
 14e:	50                   	push   %eax
 14f:	e8 2c 07 00 00       	call   880 <malloc>
  void* original = stack;
  //Check page alignmenet
  if((uint)stack % PGSIZE != 0){
 154:	8b 0d 5c 0d 00 00    	mov    0xd5c,%ecx
 ...
 165:	01 d9                	add    %ebx,%ecx
 167:	29 d0                	sub    %edx,%eax
 169:	01 d8                	add    %ebx,%eax
 16b:	85 d2                	test   %edx,%edx
 16d:	0f 45 c8             	cmovne %eax,%ecx
  }
  else{
    stack += PGSIZE;
  }
 ...
 172:	eb 0c                	jmp    180 <thread_create+0x40>
 174:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 178:	83 c2 01             	add    $0x1,%edx
 17b:	83 fa 40             	cmp    $0x40,%edx
 17e:	74 2f                	je     1af <thread_create+0x6f>
    if(!stack_addrs[i] && !inUse[i]){ //TODO try and change this.
 180:	8b 04 95 60 0f 00 00 	mov    0xf60(,%edx,4),%eax
 187:	85 c0                	test   %eax,%eax
 189:	75 ed                	jne    178 <thread_create+0x38>
 18b:	8b 04 95 60 0d 00 00 	mov    0xd60(,%edx,4),%eax
 192:	85 c0                	test   %eax,%eax
 194:	75 e2                	jne    178 <thread_create+0x38>
      inUse[i] = 1;
 196:	c7 04 95 60 0d 00 00 	movl   $0x1,0xd60(,%edx,4)
 19d:	01 00 00 00 
      malloc_addrs[i] = original;
 1a1:	89 1c 95 60 0e 00 00 	mov    %ebx,0xe60(,%edx,4)
      stack_addrs[i] = stack;
 1a8:	89 0c 95 60 0f 00 00 	mov    %ecx,0xf60(,%edx,4)
      break;
    }
  }
  int threadId = clone(start_routine, arg1, arg2, stack);
 1af:	51                   	push   %ecx
 1b0:	ff 75 10             	push   0x10(%ebp)
 1b3:	ff 75 0c             	push   0xc(%ebp)
 1b6:	ff 75 08             	push   0x8(%ebp)
 1b9:	e8 c5 03 00 00       	call   583 <clone>
...
{
 1d9:	83 ec 30             	sub    $0x30,%esp
  int threadId = join(&stackAddr);
 1dc:	50                   	push   %eax
 1dd:	e8 a9 03 00 00       	call   58b <join>
 ...
 1f6:	74 4c                	je     244 <thread_join+0x74>
    if (inUse[i] == 1 && stack_addrs[i] == stackAddr){ // if joined freer the stack 
 1f8:	83 3c 9d 60 0d 00 00 	cmpl   $0x1,0xd60(,%ebx,4)
 1ff:	01 
 200:	75 ee                	jne    1f0 <thread_join+0x20>
 202:	39 14 9d 60 0f 00 00 	cmp    %edx,0xf60(,%ebx,4)
 209:	75 e5                	jne    1f0 <thread_join+0x20>
      free(malloc_addrs[i]);
 20b:	83 ec 0c             	sub    $0xc,%esp
 20e:	ff 34 9d 60 0e 00 00 	push   0xe60(,%ebx,4)
 215:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 218:	e8 d3 05 00 00       	call   7f0 <free>
      malloc_addrs[i] = 0;
      stack_addrs[i] = 0;
      inUse[i] = 0;
      break;
 ...
 220:	83 c4 10             	add    $0x10,%esp
      malloc_addrs[i] = 0;
 223:	c7 04 9d 60 0e 00 00 	movl   $0x0,0xe60(,%ebx,4)
 22a:	00 00 00 00 
      stack_addrs[i] = 0;
 22e:	c7 04 9d 60 0f 00 00 	movl   $0x0,0xf60(,%ebx,4)
 235:	00 00 00 00 
      inUse[i] = 0;
 239:	c7 04 9d 60 0d 00 00 	movl   $0x0,0xd60(,%ebx,4)
 240:	00 00 00 00 
    }
  }
  return threadId; 
...
xchg(volatile uint *addr, uint newval)
{
 ...
 261:	b9 01 00 00 00       	mov    $0x1,%ecx
...
void lock_release(lock_t *lock){
 ...
 288:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lock->flag, 0);
}
 28b:	5d                   	pop    %ebp
 28c:	c3                   	ret    
...
free(void *ap)
{
 ...
 7f1:	a1 60 10 00 00       	mov    0x1060,%eax
{
 ...
 831:	5b                   	pop    %ebx
  freep = p;
 832:	89 15 60 10 00 00    	mov    %edx,0x1060
}
 838:	5e                   	pop    %esi
 839:	5f                   	pop    %edi
 83a:	5d                   	pop    %ebp
 ...
 869:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 86c:	89 15 60 10 00 00    	mov    %edx,0x1060
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 889:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 88c:	8b 3d 60 10 00 00    	mov    0x1060,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8cf:	73 4f                	jae    920 <malloc+0xa0>
    ...
    if(p == freep)
 8d1:	8b 3d 60 10 00 00    	mov    0x1060,%edi
 ...
 8fa:	e8 f1 fe ff ff       	call   7f0 <free>
  return freep;
 8ff:	8b 15 60 10 00 00    	mov    0x1060,%edx
 ...
 92c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 92f:	89 15 60 10 00 00    	mov    %edx,0x1060
}
 ...
 93f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 940:	c7 05 60 10 00 00 64 	movl   $0x1064,0x1060
 947:	10 00 00 
    base.s.size = 0;
 94a:	bf 64 10 00 00       	mov    $0x1064,%edi
    base.s.ptr = freep = prevp = &base;
 94f:	c7 05 64 10 00 00 64 	movl   $0x1064,0x1064
 956:	10 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 959:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 95b:	c7 05 68 10 00 00 00 	movl   $0x0,0x1068
 962:	00 00 00 
    if(p->s.size >= nunits){
