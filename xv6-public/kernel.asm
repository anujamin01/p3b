...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 cf 43 00 00       	jmp    80104640 <release>
    panic("brelse");
...
80100551:	e8 aa 42 00 00       	call   80104800 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 f5 41 00 00       	call   80104760 <memset>
  outb(CRTPORT+1, pos);
...
801005ab:	e8 f0 40 00 00       	call   801046a0 <acquire>
  for(i = 0; i < n; i++)
...
801005e4:	e8 57 40 00 00       	call   80104640 <release>
  ilock(ip);
801005e9:	58                   	pop    %eax
...
801007e8:	e8 b3 3e 00 00       	call   801046a0 <acquire>
...
8010085b:	e8 e0 3d 00 00       	call   80104640 <release>
...
80100893:	e8 08 3e 00 00       	call   801046a0 <acquire>
  while((c = getc()) >= 0){
...
801009d0:	e8 6b 3c 00 00       	call   80104640 <release>
  if(doprocdump) {
...
80100cd3:	e8 88 3c 00 00       	call   80104960 <strlen>
...
80100ce4:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100ce7:	e8 74 3c 00 00       	call   80104960 <strlen>
...
80100da1:	e8 7a 3b 00 00       	call   80104920 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e20:	e8 ab 36 00 00       	call   801044d0 <initlock>
}
...
80100e41:	e8 5a 38 00 00       	call   801046a0 <acquire>
...
80100e71:	e8 ca 37 00 00       	call   80104640 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e8a:	e8 b1 37 00 00       	call   80104640 <release>
}
...
80100eaf:	e8 ec 37 00 00       	call   801046a0 <acquire>
  if(f->ref < 1)
...
80100ecc:	e8 6f 37 00 00       	call   80104640 <release>
  return f;
}
...
80100f01:	e8 9a 37 00 00       	call   801046a0 <acquire>
  if(f->ref < 1)
...
80100f39:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100f3c:	e8 ff 36 00 00       	call   80104640 <release>
...
80100f6d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f6e:	e9 cd 36 00 00       	jmp    80104640 <release>
...
80101325:	e8 36 34 00 00       	call   80104760 <memset>
  log_write(bp);
...
80101541:	e8 ba 32 00 00       	call   80104800 <memmove>
  brelse(bp);
...
80101576:	e8 55 2f 00 00       	call   801044d0 <initlock>
  for(i = 0; i < NINODE; i++) {
...
80101589:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
8010158f:	e8 0c 2e 00 00       	call   801043a0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015bc:	e8 3f 32 00 00       	call   80104800 <memmove>
  brelse(bp);
...
8010168e:	e8 cd 30 00 00       	call   80104760 <memset>
      dip->type = type;
...
80101731:	e8 ca 30 00 00       	call   80104800 <memmove>
  log_write(bp);
...
8010175f:	e8 3c 2f 00 00       	call   801046a0 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010176f:	e8 cc 2e 00 00       	call   80104640 <release>
}
...
801017a2:	e8 39 2c 00 00       	call   801043e0 <acquiresleep>
  if(ip->valid == 0){
...
80101818:	e8 e3 2f 00 00       	call   80104800 <memmove>
    brelse(bp);
...
80101873:	e8 08 2c 00 00       	call   80104480 <holdingsleep>
...
8010188e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010188f:	e9 ac 2b 00 00       	jmp    80104440 <releasesleep>
    panic("iunlock");
...
801018c0:	e8 1b 2b 00 00       	call   801043e0 <acquiresleep>
...
801018da:	e8 61 2b 00 00       	call   80104440 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
801018e6:	e8 b5 2d 00 00       	call   801046a0 <acquire>
  ip->ref--;
...
801018ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101900:	e9 3b 2d 00 00       	jmp    80104640 <release>
80101905:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101908:	83 ec 0c             	sub    $0xc,%esp
8010190b:	68 60 f9 10 80       	push   $0x8010f960
80101910:	e8 8b 2d 00 00       	call   801046a0 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010191f:	e8 1c 2d 00 00       	call   80104640 <release>
    if(r == 1){
...
80101a23:	e8 58 2a 00 00       	call   80104480 <holdingsleep>
...
80101a3a:	e8 01 2a 00 00       	call   80104440 <releasesleep>
  iput(ip);
...
80101b37:	e8 c4 2c 00 00       	call   80104800 <memmove>
    brelse(bp);
...
80101c33:	e8 c8 2b 00 00       	call   80104800 <memmove>
    log_write(bp);
...
80101cce:	e8 9d 2b 00 00       	call   80104870 <strncmp>
}
80101cd3:	c9                   	leave  
80101cd4:	c3                   	ret    
...
80101d2d:	e8 3e 2b 00 00       	call   80104870 <strncmp>
      continue;
...
80101dba:	e8 e1 28 00 00       	call   801046a0 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dca:	e8 71 28 00 00       	call   80104640 <release>
...
80101e27:	e8 d4 29 00 00       	call   80104800 <memmove>
...
80101e8c:	e8 ef 25 00 00       	call   80104480 <holdingsleep>
...
80101eae:	e8 8d 25 00 00       	call   80104440 <releasesleep>
  iput(ip);
...
80101edb:	e8 20 29 00 00       	call   80104800 <memmove>
    name[len] = 0;
...
80101f2b:	e8 50 25 00 00       	call   80104480 <holdingsleep>
...
80101f4a:	e8 f1 24 00 00       	call   80104440 <releasesleep>
  iput(ip);
...
80101f6d:	e8 0e 25 00 00       	call   80104480 <holdingsleep>
...
80101f90:	e8 eb 24 00 00       	call   80104480 <holdingsleep>
...
80101fa7:	e8 94 24 00 00       	call   80104440 <releasesleep>
}
...
8010203d:	e8 7e 28 00 00       	call   801048c0 <strncpy>
...
801021d0:	e8 fb 22 00 00       	call   801044d0 <initlock>
...
8010224e:	e8 4d 24 00 00       	call   801046a0 <acquire>
...
801022cb:	e8 70 23 00 00       	call   80104640 <release>
...
801022ee:	e8 8d 21 00 00       	call   80104480 <holdingsleep>
...
80102328:	e8 73 23 00 00       	call   801046a0 <acquire>
...
80102385:	c9                   	leave  
  release(&idelock);
80102386:	e9 b5 22 00 00       	jmp    80104640 <release>
...
801024f2:	e8 69 22 00 00       	call   80104760 <memset>
...
80102528:	e8 73 21 00 00       	call   801046a0 <acquire>
...
80102542:	c9                   	leave  
    release(&kmem.lock);
80102543:	e9 f8 20 00 00       	jmp    80104640 <release>
    panic("kfree");
...
80102625:	e8 a6 1e 00 00       	call   801044d0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801026b3:	e8 e8 1f 00 00       	call   801046a0 <acquire>
  r = kmem.freelist;
...
801026e1:	e8 5a 1f 00 00       	call   80104640 <release>
  return (char*)r;
...
80102af7:	e8 b4 1c 00 00       	call   801047b0 <memcmp>
...
80102c24:	e8 d7 1b 00 00       	call   80104800 <memmove>
...
80102cd4:	e8 f7 17 00 00       	call   801044d0 <initlock>
  readsb(dev, &sb);
80102cd9:	58                   	pop    %eax
...
80102d6b:	e8 30 19 00 00       	call   801046a0 <acquire>
...
80102dbc:	e8 7f 18 00 00       	call   80104640 <release>
      break;
    }
  }
}
...
80102dde:	e8 bd 18 00 00       	call   801046a0 <acquire>
  log.outstanding -= 1;
...
80102e1c:	e8 1f 18 00 00       	call   80104640 <release>
}
...
80102e36:	e8 65 18 00 00       	call   801046a0 <acquire>
    wakeup(&log);
...
80102e58:	e8 e3 17 00 00       	call   80104640 <release>
...
80102eb4:	e8 47 19 00 00       	call   80104800 <memmove>
...
80102f14:	e8 27 17 00 00       	call   80104640 <release>
...
80102f76:	e8 25 17 00 00       	call   801046a0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80103022:	e8 49 2a 00 00       	call   80105a70 <idtinit>
...
80103046:	e8 15 3b 00 00       	call   80106b60 <switchkvm>
  seginit();
8010304b:	e8 80 3a 00 00       	call   80106ad0 <seginit>
  lapicinit();
...
80103081:	e8 ca 3f 00 00       	call   80107050 <kvmalloc>
  mpinit();        // detect other processors
80103086:	e8 85 01 00 00       	call   80103210 <mpinit>
  lapicinit();     // interrupt controller
8010308b:	e8 60 f7 ff ff       	call   801027f0 <lapicinit>
  seginit();       // segment descriptors
80103090:	e8 3b 3a 00 00       	call   80106ad0 <seginit>
  picinit();       // disable pic
...
801030a4:	e8 b7 2c 00 00       	call   80105d60 <uartinit>
  pinit();         // process table
801030a9:	e8 32 08 00 00       	call   801038e0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 3d 29 00 00       	call   801059f0 <tvinit>
  binit();         // buffer cache
...
801030d4:	e8 27 17 00 00       	call   80104800 <memmove>
...
801031c4:	e8 e7 15 00 00       	call   801047b0 <memcmp>
...
8010327c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010327f:	e8 2c 15 00 00       	call   801047b0 <memcmp>
...
801033c8:	e8 e3 13 00 00       	call   801047b0 <memcmp>
...
801034a9:	e8 22 10 00 00       	call   801044d0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010353f:	e8 5c 11 00 00       	call   801046a0 <acquire>
  if(writable){
...
80103583:	5d                   	pop    %ebp
    release(&p->lock);
80103584:	e9 b7 10 00 00       	jmp    80104640 <release>
...
801035dd:	e8 be 10 00 00       	call   801046a0 <acquire>
  for(i = 0; i < n; i++){
...
8010366c:	e8 cf 0f 00 00       	call   80104640 <release>
        return -1;
...
801036c2:	e8 79 0f 00 00       	call   80104640 <release>
  return n;
...
801036e6:	e8 b5 0f 00 00       	call   801046a0 <acquire>
...
801037c1:	e8 da 0e 00 00       	call   801046a0 <acquire>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 e2 59 10 80 	movl   $0x801059e2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103836:	e8 25 0f 00 00       	call   80104760 <memset>
...
8010388b:	e8 b0 0d 00 00       	call   80104640 <release>
...
801038e6:	68 60 78 10 80       	push   $0x80107860
801038eb:	68 20 1d 11 80       	push   $0x80111d20
801038f0:	e8 db 0b 00 00       	call   801044d0 <initlock>
}
...
80103984:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103987:	e8 c4 0b 00 00       	call   80104550 <pushcli>
  c = mycpu();
8010398c:	e8 6f ff ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103991:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103997:	e8 04 0c 00 00       	call   801045a0 <popcli>
}
...
801039c3:	e8 08 36 00 00       	call   80106fd0 <setupkvm>
...
801039f6:	e8 65 0d 00 00       	call   80104760 <memset>
...
80103a4f:	68 90 78 10 80       	push   $0x80107890
80103a54:	50                   	push   %eax
80103a55:	e8 c6 0e 00 00       	call   80104920 <safestrcpy>
  p->cwd = namei("/");
80103a5a:	c7 04 24 99 78 10 80 	movl   $0x80107899,(%esp)
...
80103a83:	e8 b8 0b 00 00       	call   80104640 <release>
}
...
80103a93:	68 77 78 10 80       	push   $0x80107877
...
80103aa5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103aa8:	e8 a3 0a 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103aad:	e8 4e fe ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103ab2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ab8:	e8 e3 0a 00 00       	call   801045a0 <popcli>
  sz = curproc->sz;
...
80103aea:	e8 01 33 00 00       	call   80106df0 <allocuvm>
...
80103b0a:	e8 11 34 00 00       	call   80106f20 <deallocuvm>
...
80103b26:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b29:	e8 22 0a 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103b2e:	e8 cd fd ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103b33:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b39:	e8 62 0a 00 00       	call   801045a0 <popcli>
  if((np = allocproc()) == 0){
...
80103b58:	e8 63 35 00 00       	call   801070c0 <copyuvm>
...
80103c6e:	e8 2d 0a 00 00       	call   801046a0 <acquire>
...
80103c90:	e8 db 2e 00 00       	call   80106b70 <switchuvm>
...
80103c9b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103ca2:	e8 d4 0c 00 00       	call   8010497b <swtch>
      switchkvm();
80103ca7:	e8 b4 2e 00 00       	call   80106b60 <switchkvm>
      c->proc = 0;
...
80103ccc:	e8 6f 09 00 00       	call   80104640 <release>
    sti();
...
80103d43:	e8 33 0c 00 00       	call   8010497b <swtch>
  mycpu()->intena = intena;
...
80103e0a:	e8 91 08 00 00       	call   801046a0 <acquire>
...
80103ead:	68 e8 78 10 80       	push   $0x801078e8
80103eb2:	e8 c9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 db 78 10 80       	push   $0x801078db
...
80103f3b:	0f 85 95 00 00 00    	jne    80103fd6 <wait+0x106>
  pushcli();
80103f41:	e8 0a 06 00 00       	call   80104550 <pushcli>
  c = mycpu();
80103f46:	e8 b5 f9 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80103f4b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f51:	e8 4a 06 00 00       	call   801045a0 <popcli>
  if(p == 0)
...
80103f99:	e8 b2 2f 00 00       	call   80106f50 <freevm>
        p->pid = 0;
...
80103fc5:	e8 76 06 00 00       	call   80104640 <release>
        return pid;
...
8010400c:	e8 8f 06 00 00       	call   801046a0 <acquire>
  pushcli();
80104011:	e8 3a 05 00 00       	call   80104550 <pushcli>
  c = mycpu();
80104016:	e8 e5 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
8010401b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104021:	e8 7a 05 00 00       	call   801045a0 <popcli>
...
80104039:	e8 02 06 00 00       	call   80104640 <release>
}
...
8010405c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010405f:	e8 ec 04 00 00       	call   80104550 <pushcli>
  c = mycpu();
80104064:	e8 97 f8 ff ff       	call   80103900 <mycpu>
  p = c->proc;
80104069:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010406f:	e8 2c 05 00 00       	call   801045a0 <popcli>
  if(p == 0)
...
80104098:	e8 a3 05 00 00       	call   80104640 <release>
  p->chan = chan;
...
801040ba:	e8 81 05 00 00       	call   80104640 <release>
    acquire(lk);
...
801040cb:	5d                   	pop    %ebp
    acquire(lk);
801040cc:	e9 cf 05 00 00       	jmp    801046a0 <acquire>
...
801040f9:	68 fa 78 10 80       	push   $0x801078fa
801040fe:	e8 7d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 f4 78 10 80       	push   $0x801078f4
...
8010411f:	e8 7c 05 00 00       	call   801046a0 <acquire>
...
80104160:	c9                   	leave  
  release(&ptable.lock);
80104161:	e9 da 04 00 00       	jmp    80104640 <release>
...
8010417f:	e8 1c 05 00 00       	call   801046a0 <acquire>
...
801041bb:	e8 80 04 00 00       	call   80104640 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041d8:	e8 63 04 00 00       	call   80104640 <release>
}
...
8010420b:	68 7f 7c 10 80       	push   $0x80107c7f
...
8010422c:	74 ea                	je     80104218 <procdump+0x28>
      state = "???";
8010422e:	ba 0b 79 10 80       	mov    $0x8010790b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104233:	83 f8 05             	cmp    $0x5,%eax
80104236:	77 11                	ja     80104249 <procdump+0x59>
80104238:	8b 14 85 6c 79 10 80 	mov    -0x7fef8694(,%eax,4),%edx
      state = "???";
8010423f:	b8 0b 79 10 80       	mov    $0x8010790b,%eax
...
8010424e:	68 0f 79 10 80       	push   $0x8010790f
...
80104275:	e8 76 02 00 00       	call   801044f0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010428d:	68 61 73 10 80       	push   $0x80107361
...
801042b6:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
801042b9:	e8 92 02 00 00       	call   80104550 <pushcli>
  c = mycpu();
801042be:	e8 3d f6 ff ff       	call   80103900 <mycpu>
  p = c->proc;
801042c3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
801042c9:	e8 d2 02 00 00       	call   801045a0 <popcli>
  int i, pid;
...
801042d5:	74 28                	je     801042ff <clone+0x4f>
...
801042d9:	8b 46 04             	mov    0x4(%esi),%eax
801042dc:	89 43 04             	mov    %eax,0x4(%ebx)
801042df:	85 c0                	test   %eax,%eax
801042e1:	75 29                	jne    8010430c <clone+0x5c>
    kfree(nt->kstack);
801042e3:	83 ec 0c             	sub    $0xc,%esp
801042e6:	ff 73 08             	push   0x8(%ebx)
801042e9:	e8 d2 e1 ff ff       	call   801024c0 <kfree>
    nt->kstack = 0;
801042ee:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    nt->state = UNUSED;
    return -1;
801042f5:	83 c4 10             	add    $0x10,%esp
    nt->state = UNUSED;
801042f8:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  release(&ptable.lock);
...
801042ff:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
8010430b:	c3                   	ret    
  nt->sz = curproc->sz;
8010430c:	8b 06                	mov    (%esi),%eax
  nt->tf->esp = (int)stack;
8010430e:	8b 55 14             	mov    0x14(%ebp),%edx
  nt->parent = curproc;
80104311:	89 73 14             	mov    %esi,0x14(%ebx)
  for(i = 0; i < NOFILE; i++)
80104314:	31 ff                	xor    %edi,%edi
  nt->sz = curproc->sz;
80104316:	89 03                	mov    %eax,(%ebx)
  nt->tf->eax = 0;
80104318:	8b 43 18             	mov    0x18(%ebx),%eax
8010431b:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  nt->tf->esp = (int)stack;
80104322:	8b 43 18             	mov    0x18(%ebx),%eax
80104325:	89 50 44             	mov    %edx,0x44(%eax)
  nt->tf->eip = (int)(fcn);
80104328:	8b 55 08             	mov    0x8(%ebp),%edx
8010432b:	8b 43 18             	mov    0x18(%ebx),%eax
8010432e:	89 50 38             	mov    %edx,0x38(%eax)
    if(curproc->ofile[i])
80104331:	8b 44 be 28          	mov    0x28(%esi,%edi,4),%eax
80104335:	85 c0                	test   %eax,%eax
80104337:	74 10                	je     80104349 <clone+0x99>
      nt->ofile[i] = filedup(curproc->ofile[i]);
80104339:	83 ec 0c             	sub    $0xc,%esp
8010433c:	50                   	push   %eax
8010433d:	e8 5e cb ff ff       	call   80100ea0 <filedup>
80104342:	83 c4 10             	add    $0x10,%esp
80104345:	89 44 bb 28          	mov    %eax,0x28(%ebx,%edi,4)
  for(i = 0; i < NOFILE; i++)
80104349:	83 c7 01             	add    $0x1,%edi
8010434c:	83 ff 10             	cmp    $0x10,%edi
8010434f:	75 e0                	jne    80104331 <clone+0x81>
  nt->cwd = idup(curproc->cwd);
80104351:	83 ec 0c             	sub    $0xc,%esp
80104354:	ff 76 68             	push   0x68(%esi)
  safestrcpy(nt->name, curproc->name, sizeof(curproc->name));
80104357:	83 c6 6c             	add    $0x6c,%esi
  nt->cwd = idup(curproc->cwd);
8010435a:	e8 f1 d3 ff ff       	call   80101750 <idup>
  safestrcpy(nt->name, curproc->name, sizeof(curproc->name));
8010435f:	83 c4 0c             	add    $0xc,%esp
  nt->cwd = idup(curproc->cwd);
80104362:	89 43 68             	mov    %eax,0x68(%ebx)
  safestrcpy(nt->name, curproc->name, sizeof(curproc->name));
80104365:	8d 43 6c             	lea    0x6c(%ebx),%eax
80104368:	6a 10                	push   $0x10
8010436a:	56                   	push   %esi
8010436b:	50                   	push   %eax
8010436c:	e8 af 05 00 00       	call   80104920 <safestrcpy>
  acquire(&ptable.lock);
80104371:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80104378:	e8 23 03 00 00       	call   801046a0 <acquire>
  nt->state = RUNNABLE;
8010437d:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80104384:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010438b:	e8 b0 02 00 00       	call   80104640 <release>
  exit(); // maybe here
80104390:	e8 0b fa ff ff       	call   80103da0 <exit>
...
801043aa:	68 84 79 10 80       	push   $0x80107984
...
801043ef:	e8 ac 02 00 00       	call   801046a0 <acquire>
  while (lk->locked) {
...
80104413:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104419:	e8 62 f5 ff ff       	call   80103980 <myproc>
...
8010442c:	5d                   	pop    %ebp
  release(&lk->lk);
8010442d:	e9 0e 02 00 00       	jmp    80104640 <release>
...
8010444f:	e8 4c 02 00 00       	call   801046a0 <acquire>
  lk->locked = 0;
...
80104464:	e8 a7 fc ff ff       	call   80104110 <wakeup>
  release(&lk->lk);
...
80104474:	5d                   	pop    %ebp
  release(&lk->lk);
80104475:	e9 c6 01 00 00       	jmp    80104640 <release>
...
80104492:	e8 09 02 00 00       	call   801046a0 <acquire>
...
801044a4:	e8 97 01 00 00       	call   80104640 <release>
  return r;
}
...
801044bb:	e8 c0 f4 ff ff       	call   80103980 <myproc>
...
801045ab:	75 35                	jne    801045e2 <popcli+0x42>
  ...
  if(--mycpu()->ncli < 0)
801045ad:	e8 4e f3 ff ff       	call   80103900 <mycpu>
...
801045cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801045d0:	e8 2b f3 ff ff       	call   80103900 <mycpu>
...
801045e5:	68 8f 79 10 80       	push   $0x8010798f
801045ea:	e8 91 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045ef:	83 ec 0c             	sub    $0xc,%esp
801045f2:	68 a6 79 10 80       	push   $0x801079a6
...
80104623:	e8 d8 f2 ff ff       	call   80103900 <mycpu>
...
8010465b:	68 ad 79 10 80       	push   $0x801079ad
...
801046b8:	75 7e                	jne    80104738 <acquire+0x98>
  popcli();
801046ba:	e8 e1 fe ff ff       	call   801045a0 <popcli>
  asm volatile("lock; xchgl %0, %1" :
801046bf:	b9 01 00 00 00       	mov    $0x1,%ecx
801046c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while(xchg(&lk->locked, 1) != 0)
801046c8:	8b 55 08             	mov    0x8(%ebp),%edx
801046cb:	89 c8                	mov    %ecx,%eax
801046cd:	f0 87 02             	lock xchg %eax,(%edx)
...
801046dc:	e8 1f f2 ff ff       	call   80103900 <mycpu>
  getcallerpcs(&lk, lk->pcs);
801046e1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  ebp = (uint*)v - 2;
801046e4:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
801046e6:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
801046e9:	31 c0                	xor    %eax,%eax
801046eb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801046ef:	90                   	nop
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801046f0:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
801046f6:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
801046fc:	77 1a                	ja     80104718 <acquire+0x78>
    pcs[i] = ebp[1];     // saved %eip
801046fe:	8b 5a 04             	mov    0x4(%edx),%ebx
80104701:	89 5c 81 0c          	mov    %ebx,0xc(%ecx,%eax,4)
  for(i = 0; i < 10; i++){
...
80104714:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(; i < 10; i++)
80104718:	8d 44 81 0c          	lea    0xc(%ecx,%eax,4),%eax
8010471c:	8d 51 34             	lea    0x34(%ecx),%edx
8010471f:	90                   	nop
    pcs[i] = 0;
80104720:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
80104726:	83 c0 04             	add    $0x4,%eax
80104729:	39 c2                	cmp    %eax,%edx
8010472b:	75 f3                	jne    80104720 <acquire+0x80>
}
...
80104732:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  r = lock->locked && lock->cpu == mycpu();
80104738:	8b 5b 08             	mov    0x8(%ebx),%ebx
8010473b:	e8 c0 f1 ff ff       	call   80103900 <mycpu>
80104740:	39 c3                	cmp    %eax,%ebx
80104742:	0f 85 72 ff ff ff    	jne    801046ba <acquire+0x1a>
  popcli();
80104748:	e8 53 fe ff ff       	call   801045a0 <popcli>
    panic("acquire");
8010474d:	83 ec 0c             	sub    $0xc,%esp
80104750:	68 b5 79 10 80       	push   $0x801079b5
80104755:	e8 26 bc ff ff       	call   80100380 <panic>
...
80104770:	09 cf                	or     %ecx,%edi
80104772:	83 e7 03             	and    $0x3,%edi
80104775:	75 29                	jne    801047a0 <memset+0x40>
    c &= 0xFF;
80104777:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010477a:	c1 e0 18             	shl    $0x18,%eax
8010477d:	89 fb                	mov    %edi,%ebx
8010477f:	c1 e9 02             	shr    $0x2,%ecx
80104782:	c1 e3 10             	shl    $0x10,%ebx
80104785:	09 d8                	or     %ebx,%eax
80104787:	09 f8                	or     %edi,%eax
80104789:	c1 e7 08             	shl    $0x8,%edi
8010478c:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
8010478e:	89 d7                	mov    %edx,%edi
80104790:	fc                   	cld    
80104791:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104793:	5b                   	pop    %ebx
80104794:	89 d0                	mov    %edx,%eax
80104796:	5f                   	pop    %edi
80104797:	5d                   	pop    %ebp
80104798:	c3                   	ret    
80104799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  asm volatile("cld; rep stosb" :
801047a0:	89 d7                	mov    %edx,%edi
801047a2:	fc                   	cld    
801047a3:	f3 aa                	rep stos %al,%es:(%edi)
801047a5:	5b                   	pop    %ebx
801047a6:	89 d0                	mov    %edx,%eax
801047a8:	5f                   	pop    %edi
801047a9:	5d                   	pop    %ebp
801047aa:	c3                   	ret    
...
801047d8:	74 16                	je     801047f0 <memcmp+0x40>
    if(*s1 != *s2)
801047da:	0f b6 0a             	movzbl (%edx),%ecx
801047dd:	0f b6 18             	movzbl (%eax),%ebx
...
80104812:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
80104815:	39 fa                	cmp    %edi,%edx
80104817:	73 1f                	jae    80104838 <memmove+0x38>
80104819:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
8010481c:	85 c9                	test   %ecx,%ecx
8010481e:	74 0c                	je     8010482c <memmove+0x2c>
      *--d = *--s;
...
80104832:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    while(n-- > 0)
80104838:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
8010483b:	89 d7                	mov    %edx,%edi
8010483d:	85 c9                	test   %ecx,%ecx
...
80104880:	74 2e                	je     801048b0 <strncmp+0x40>
80104882:	01 d6                	add    %edx,%esi
80104884:	eb 18                	jmp    8010489e <strncmp+0x2e>
80104886:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010488d:	8d 76 00             	lea    0x0(%esi),%esi
80104890:	38 d8                	cmp    %bl,%al
80104892:	75 14                	jne    801048a8 <strncmp+0x38>
    n--, p++, q++;
80104894:	83 c2 01             	add    $0x1,%edx
80104897:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010489a:	39 f2                	cmp    %esi,%edx
8010489c:	74 12                	je     801048b0 <strncmp+0x40>
8010489e:	0f b6 01             	movzbl (%ecx),%eax
801048a1:	0f b6 1a             	movzbl (%edx),%ebx
801048a4:	84 c0                	test   %al,%al
801048a6:	75 e8                	jne    80104890 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
801048a8:	29 d8                	sub    %ebx,%eax
}
801048aa:	5b                   	pop    %ebx
801048ab:	5e                   	pop    %esi
801048ac:	5d                   	pop    %ebp
...
801048c9:	8b 4d 10             	mov    0x10(%ebp),%ecx
  char *os;
...
801048da:	0f b6 57 ff          	movzbl -0x1(%edi),%edx
801048de:	88 50 ff             	mov    %dl,-0x1(%eax)
801048e1:	84 d2                	test   %dl,%dl
801048e3:	74 09                	je     801048ee <strncpy+0x2e>
801048e5:	89 cb                	mov    %ecx,%ebx
801048e7:	83 e9 01             	sub    $0x1,%ecx
801048ea:	85 db                	test   %ebx,%ebx
801048ec:	7f e2                	jg     801048d0 <strncpy+0x10>
    ;
  while(n-- > 0)
801048ee:	89 c2                	mov    %eax,%edx
801048f0:	85 c9                	test   %ecx,%ecx
801048f2:	7e 17                	jle    8010490b <strncpy+0x4b>
801048f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    *s++ = 0;
801048f8:	83 c2 01             	add    $0x1,%edx
801048fb:	89 c1                	mov    %eax,%ecx
801048fd:	c6 42 ff 00          	movb   $0x0,-0x1(%edx)
  while(n-- > 0)
80104901:	29 d1                	sub    %edx,%ecx
80104903:	8d 4c 0b ff          	lea    -0x1(%ebx,%ecx,1),%ecx
80104907:	85 c9                	test   %ecx,%ecx
80104909:	7f ed                	jg     801048f8 <strncpy+0x38>
  return os;
}
8010490b:	5b                   	pop    %ebx
...
80104997:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010499a:	e8 e1 ef ff ff       	call   80103980 <myproc>
...
801049e1:	76 2d                	jbe    80104a10 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
...
801049fb:	39 c2                	cmp    %eax,%edx
801049fd:	76 11                	jbe    80104a10 <fetchstr+0x40>
    if(*s == 0)
...
80104a33:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a36:	e8 45 ef ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a76:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104a79:	e8 02 ef ff ff       	call   80103980 <myproc>
80104a7e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a80:	e8 fb ee ff ff       	call   80103980 <myproc>
...
80104a8e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a91:	e8 ea ee ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ab4:	76 1a                	jbe    80104ad0 <argptr+0x60>
...
80104ae4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ae5:	e8 96 ee ff ff       	call   80103980 <myproc>
...
80104af3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104af6:	e8 85 ee ff ff       	call   80103980 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b0b:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104b0e:	e8 6d ee ff ff       	call   80103980 <myproc>
  if(addr >= curproc->sz)
...
80104b35:	76 11                	jbe    80104b48 <argstr+0x68>
    if(*s == 0)
...
80104b7c:	8b 14 85 e0 79 10 80 	mov    -0x7fef8620(,%eax,4),%edx
...
80104ba8:	68 bd 79 10 80       	push   $0x801079bd
...
80104be7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104bea:	e8 d1 d4 ff ff       	call   801020c0 <nameiparent>
...
80104c0c:	e8 cf d0 ff ff       	call   80101ce0 <dirlookup>
...
80104c1e:	e8 ed cd ff ff       	call   80101a10 <iunlockput>
    ilock(ip);
80104c23:	89 34 24             	mov    %esi,(%esp)
80104c26:	e8 55 cb ff ff       	call   80101780 <ilock>
...
80104c54:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
80104c56:	e8 b5 cd ff ff       	call   80101a10 <iunlockput>
    return 0;
...
80104c7a:	e8 91 c9 ff ff       	call   80101610 <ialloc>
...
80104cb1:	e8 1a ca ff ff       	call   801016d0 <iupdate>
...
80104cc8:	e8 13 d3 ff ff       	call   80101fe0 <dirlink>
...
80104cd8:	e8 33 cd ff ff       	call   80101a10 <iunlockput>
  return ip;
...
80104cf9:	e8 d2 c9 ff ff       	call   801016d0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104cfe:	83 c4 0c             	add    $0xc,%esp
80104d01:	ff 76 04             	push   0x4(%esi)
80104d04:	68 5c 7a 10 80       	push   $0x80107a5c
80104d09:	56                   	push   %esi
80104d0a:	e8 d1 d2 ff ff       	call   80101fe0 <dirlink>
...
80104d1c:	68 5b 7a 10 80       	push   $0x80107a5b
80104d21:	56                   	push   %esi
80104d22:	e8 b9 d2 ff ff       	call   80101fe0 <dirlink>
...
80104d31:	68 4f 7a 10 80       	push   $0x80107a4f
...
80104d4f:	68 5e 7a 10 80       	push   $0x80107a5e
80104d54:	e8 27 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d59:	83 ec 0c             	sub    $0xc,%esp
80104d5c:	68 40 7a 10 80       	push   $0x80107a40
...
80104d7e:	e8 9d fc ff ff       	call   80104a20 <argint>
...
80104dd8:	e8 c3 c0 ff ff       	call   80100ea0 <filedup>
  return fd;
...
80104dfe:	e8 1d fc ff ff       	call   80104a20 <argint>
...
80104e29:	e8 f2 fb ff ff       	call   80104a20 <argint>
...
80104e3e:	e8 2d fc ff ff       	call   80104a70 <argptr>
...
80104e54:	e8 c7 c1 ff ff       	call   80101020 <fileread>
...
80104e7e:	e8 9d fb ff ff       	call   80104a20 <argint>
...
80104ea9:	e8 72 fb ff ff       	call   80104a20 <argint>
...
80104ebe:	e8 ad fb ff ff       	call   80104a70 <argptr>
...
80104ed4:	e8 d7 c1 ff ff       	call   801010b0 <filewrite>
...
80104efe:	e8 1d fb ff ff       	call   80104a20 <argint>
...
80104f21:	74 25                	je     80104f48 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104f23:	e8 58 ea ff ff       	call   80103980 <myproc>
  fileclose(f);
...
80104f34:	e8 b7 bf ff ff       	call   80100ef0 <fileclose>
  return 0;
...
80104f5e:	e8 bd fa ff ff       	call   80104a20 <argint>
...
80104f70:	e8 0b ea ff ff       	call   80103980 <myproc>
...
80104f88:	e8 e3 fa ff ff       	call   80104a70 <argptr>
...
80104f9b:	e8 30 c0 ff ff       	call   80100fd0 <filestat>
...
80104fcf:	e8 0c fb ff ff       	call   80104ae0 <argstr>
...
80105038:	e8 93 c6 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
8010503d:	89 1c 24             	mov    %ebx,(%esp)
80105040:	e8 1b c8 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105045:	58                   	pop    %eax
80105046:	5a                   	pop    %edx
80105047:	57                   	push   %edi
80105048:	ff 75 d0             	push   -0x30(%ebp)
8010504b:	e8 70 d0 ff ff       	call   801020c0 <nameiparent>
...
8010505d:	e8 1e c7 ff ff       	call   80101780 <ilock>
...
80105073:	e8 68 cf ff ff       	call   80101fe0 <dirlink>
...
80105083:	e8 88 c9 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
80105088:	89 1c 24             	mov    %ebx,(%esp)
8010508b:	e8 20 c8 ff ff       	call   801018b0 <iput>
  end_op();
80105090:	e8 3b dd ff ff       	call   80102dd0 <end_op>
  return 0;
...
801050ac:	e8 5f c9 ff ff       	call   80101a10 <iunlockput>
    goto bad;
801050b1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
801050b4:	83 ec 0c             	sub    $0xc,%esp
801050b7:	53                   	push   %ebx
801050b8:	e8 c3 c6 ff ff       	call   80101780 <ilock>
  ip->nlink--;
801050bd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801050c2:	89 1c 24             	mov    %ebx,(%esp)
801050c5:	e8 06 c6 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801050ca:	89 1c 24             	mov    %ebx,(%esp)
801050cd:	e8 3e c9 ff ff       	call   80101a10 <iunlockput>
  end_op();
801050d2:	e8 f9 dc ff ff       	call   80102dd0 <end_op>
  return -1;
...
801050e5:	e8 26 c9 ff ff       	call   80101a10 <iunlockput>
    end_op();
801050ea:	e8 e1 dc ff ff       	call   80102dd0 <end_op>
    return -1;
801050ef:	83 c4 10             	add    $0x10,%esp
801050f2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050f7:	eb a1                	jmp    8010509a <sys_link+0xda>
    end_op();
801050f9:	e8 d2 dc ff ff       	call   80102dd0 <end_op>
    return -1;
801050fe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105103:	eb 95                	jmp    8010509a <sys_link+0xda>
...
8010515d:	58                   	pop    %eax
8010515e:	5a                   	pop    %edx
8010515f:	68 5c 7a 10 80       	push   $0x80107a5c
80105164:	53                   	push   %ebx
80105165:	e8 56 cb ff ff       	call   80101cc0 <namecmp>
...
80105178:	68 5b 7a 10 80       	push   $0x80107a5b
8010517d:	53                   	push   %ebx
8010517e:	e8 3d cb ff ff       	call   80101cc0 <namecmp>
...
80105197:	e8 44 cb ff ff       	call   80101ce0 <dirlookup>
...
801051ad:	e8 ce c5 ff ff       	call   80101780 <ilock>
  if(ip->nlink < 1)
801051b2:	83 c4 10             	add    $0x10,%esp
801051b5:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
801051ba:	0f 8e 1c 01 00 00    	jle    801052dc <sys_unlink+0x1cc>
...
80105202:	e8 09 c8 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
80105207:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010520c:	89 1c 24             	mov    %ebx,(%esp)
8010520f:	e8 bc c4 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
80105214:	89 1c 24             	mov    %ebx,(%esp)
80105217:	e8 f4 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010521c:	e8 af db ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010524d:	e8 3e c8 ff ff       	call   80101a90 <readi>
80105252:	83 c4 10             	add    $0x10,%esp
80105255:	83 f8 10             	cmp    $0x10,%eax
80105258:	75 68                	jne    801052c2 <sys_unlink+0x1b2>
    if(de.inum != 0)
...
80105276:	e8 95 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010527b:	e8 50 db ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010529c:	e8 2f c4 ff ff       	call   801016d0 <iupdate>
...
801052ae:	e9 73 ff ff ff       	jmp    80105226 <sys_unlink+0x116>
    end_op();
801052b3:	e8 18 db ff ff       	call   80102dd0 <end_op>
    return -1;
801052b8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801052bd:	e9 64 ff ff ff       	jmp    80105226 <sys_unlink+0x116>
      panic("isdirempty: readi");
801052c2:	83 ec 0c             	sub    $0xc,%esp
801052c5:	68 80 7a 10 80       	push   $0x80107a80
801052ca:	e8 b1 b0 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
801052cf:	83 ec 0c             	sub    $0xc,%esp
801052d2:	68 92 7a 10 80       	push   $0x80107a92
801052d7:	e8 a4 b0 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
801052dc:	83 ec 0c             	sub    $0xc,%esp
801052df:	68 6e 7a 10 80       	push   $0x80107a6e
801052e4:	e8 97 b0 ff ff       	call   80100380 <panic>
...
801052ff:	e8 dc f7 ff ff       	call   80104ae0 <argstr>
...
80105318:	e8 03 f7 ff ff       	call   80104a20 <argint>
...
80105322:	78 79                	js     8010539d <sys_open+0xad>
  ...
  begin_op();
80105324:	e8 37 da ff ff       	call   80102d60 <begin_op>
...
80105332:	ff 75 e0             	push   -0x20(%ebp)
80105335:	e8 66 cd ff ff       	call   801020a0 <namei>
...
8010534b:	e8 30 c4 ff ff       	call   80101780 <ilock>
...
80105390:	e8 7b c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
801053e0:	e8 7b c4 ff ff       	call   80101860 <iunlock>
  end_op();
801053e5:	e8 e6 d9 ff ff       	call   80102dd0 <end_op>
...
80105444:	e8 97 f6 ff ff       	call   80104ae0 <argstr>
...
8010545f:	e8 6c f7 ff ff       	call   80104bd0 <create>
...
801054a4:	e8 37 f6 ff ff       	call   80104ae0 <argstr>
...
801054b9:	e8 62 f5 ff ff       	call   80104a20 <argint>
  if((argstr(0, &path)) < 0 ||
...
801054ce:	e8 4d f5 ff ff       	call   80104a20 <argint>
     argint(1, &major) < 0 ||
...
801054ee:	e8 dd f6 ff ff       	call   80104bd0 <create>
     argint(2, &minor) < 0 ||
...
80105525:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105528:	e8 53 e4 ff ff       	call   80103980 <myproc>
...
8010553d:	e8 9e f5 ff ff       	call   80104ae0 <argstr>
...
801055e5:	e8 f6 f4 ff ff       	call   80104ae0 <argstr>
...
80105601:	e8 1a f4 ff ff       	call   80104a20 <argint>
...
80105620:	e8 3b f1 ff ff       	call   80104760 <memset>
...
8010564a:	e8 41 f3 ff ff       	call   80104990 <fetchint>
...
80105668:	e8 63 f3 ff ff       	call   801049d0 <fetchstr>
...
801056f7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056f9:	e8 82 e2 ff ff       	call   80103980 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057cc:	e8 9f f2 ff ff       	call   80104a70 <argptr>
801057d1:	83 c4 10             	add    $0x10,%esp
801057d4:	85 c0                	test   %eax,%eax
801057d6:	78 18                	js     801057f0 <sys_clone+0x60>
    return -1;
  } 
...
801057e3:	e8 88 f2 ff ff       	call   80104a70 <argptr>
...
801057eb:	c9                   	leave  
  if (argptr(0, (void*)&arg2,sizeof(*arg2)) < 0){
801057ec:	c1 f8 1f             	sar    $0x1f,%eax
}
801057ef:	c3                   	ret    
801057f0:	c9                   	leave  
    return -1;
...
80105809:	6a 04                	push   $0x4
8010580b:	50                   	push   %eax
8010580c:	6a 00                	push   $0x0
8010580e:	e8 5d f2 ff ff       	call   80104a70 <argptr>
    return -1;
  } 
  return 0; //join(stack);
}
...
{
  return fork();
80105820:	e9 fb e2 ff ff       	jmp    80103b20 <fork>
...
80105833:	83 ec 08             	sub    $0x8,%esp
  exit();
80105836:	e8 65 e5 ff ff       	call   80103da0 <exit>
...
{
  return wait();
80105840:	e9 8b e6 ff ff       	jmp    80103ed0 <wait>
...
8010585c:	e8 bf f1 ff ff       	call   80104a20 <argint>
...
8010586b:	ff 75 f4             	push   -0xc(%ebp)
8010586e:	e8 fd e8 ff ff       	call   80104170 <kill>
...
80105893:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105896:	e8 e5 e0 ff ff       	call   80103980 <myproc>
...
801058c1:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
801058c3:	ff 75 f4             	push   -0xc(%ebp)
801058c6:	e8 d5 e1 ff ff       	call   80103aa0 <growproc>
...
801058fd:	e8 1e f1 ff ff       	call   80104a20 <argint>
...
8010591a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010591d:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
80105938:	68 60 3c 11 80       	push   $0x80113c60
8010593d:	e8 0e e7 ff ff       	call   80104050 <sleep>
  while(ticks - ticks0 < n){
80105942:	a1 60 3c 11 80       	mov    0x80113c60,%eax
...
8010594f:	73 2f                	jae    80105980 <sys_sleep+0x90>
    if(myproc()->killed){
80105951:	e8 2a e0 ff ff       	call   80103980 <myproc>
...
80105965:	e8 d6 ec ff ff       	call   80104640 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105988:	e8 b3 ec ff ff       	call   80104640 <release>
  return 0;
...
801059a4:	83 ec 10             	sub    $0x10,%esp
  ...
  uint xticks;
  acquire(&tickslock);
801059a7:	68 80 3c 11 80       	push   $0x80113c80
801059ac:	e8 ef ec ff ff       	call   801046a0 <acquire>
  xticks = ticks;
801059b1:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  release(&tickslock);
801059b7:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
801059be:	e8 7d ec ff ff       	call   80104640 <release>
  return xticks;
}
...
80105a3e:	00 00 ef 
  initlock(&tickslock, "time");
80105a41:	68 a1 7a 10 80       	push   $0x80107aa1
...
80105ac4:	ff 24 85 48 7b 10 80 	jmp    *-0x7fef84b8(,%eax,4)
...
80105acf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
80105ad0:	e8 6b c7 ff ff       	call   80102240 <ideintr>
    lapiceoi();
...
80105b70:	e8 eb dd ff ff       	call   80103960 <cpuid>
...
80105bb2:	e8 c9 dd ff ff       	call   80103980 <myproc>
80105bb7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bbe:	e8 bd dd ff ff       	call   80103980 <myproc>
...
80105bd4:	0f 85 3e ff ff ff    	jne    80105b18 <trap+0x78>
    yield();
80105bda:	e8 21 e4 ff ff       	call   80104000 <yield>
...
80105bef:	e8 6c dd ff ff       	call   80103960 <cpuid>
80105bf4:	57                   	push   %edi
80105bf5:	56                   	push   %esi
80105bf6:	50                   	push   %eax
80105bf7:	68 ac 7a 10 80       	push   $0x80107aac
80105bfc:	e8 9f aa ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105c01:	e8 0a cd ff ff       	call   80102910 <lapiceoi>
    break;
...
80105c35:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105c38:	e8 23 ef ff ff       	call   80104b60 <syscall>
    if(myproc()->killed)
80105c3d:	e8 3e dd ff ff       	call   80103980 <myproc>
...
80105c53:	5d                   	pop    %ebp
      exit();
80105c54:	e9 47 e1 ff ff       	jmp    80103da0 <exit>
...
80105c65:	e8 a6 cc ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c6a:	e8 11 dd ff ff       	call   80103980 <myproc>
...
80105c7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105c80:	e8 4b cb ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
...
80105c9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105ca0:	e8 bb dc ff ff       	call   80103960 <cpuid>
80105ca5:	85 c0                	test   %eax,%eax
80105ca7:	0f 85 28 fe ff ff    	jne    80105ad5 <trap+0x35>
      acquire(&tickslock);
80105cad:	83 ec 0c             	sub    $0xc,%esp
80105cb0:	68 80 3c 11 80       	push   $0x80113c80
80105cb5:	e8 e6 e9 ff ff       	call   801046a0 <acquire>
      wakeup(&ticks);
80105cba:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105cc1:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105cc8:	e8 43 e4 ff ff       	call   80104110 <wakeup>
      release(&tickslock);
80105ccd:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105cd4:	e8 67 e9 ff ff       	call   80104640 <release>
...
80105db7:	74 78                	je     80105e31 <uartinit+0xd1>
  uart = 1;
80105db9:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105dc0:	00 00 00 
...
80105dcc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105dcf:	bf c8 7b 10 80       	mov    $0x80107bc8,%edi
80105dd4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105dd9:	6a 00                	push   $0x0
80105ddb:	6a 04                	push   $0x4
80105ddd:	e8 9e c6 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105e05:	e8 26 cb ff ff       	call   80102930 <microdelay>
...
80105eb7:	6a 00                	push   $0x0
  jmp alltraps
80105eb9:	e9 0c fb ff ff       	jmp    801059ca <alltraps>
...
80105ec0:	6a 01                	push   $0x1
  jmp alltraps
80105ec2:	e9 03 fb ff ff       	jmp    801059ca <alltraps>
...
80105ec9:	6a 02                	push   $0x2
  jmp alltraps
80105ecb:	e9 fa fa ff ff       	jmp    801059ca <alltraps>
...
80105ed2:	6a 03                	push   $0x3
  jmp alltraps
80105ed4:	e9 f1 fa ff ff       	jmp    801059ca <alltraps>
...
80105edb:	6a 04                	push   $0x4
  jmp alltraps
80105edd:	e9 e8 fa ff ff       	jmp    801059ca <alltraps>
...
80105ee4:	6a 05                	push   $0x5
  jmp alltraps
80105ee6:	e9 df fa ff ff       	jmp    801059ca <alltraps>
...
80105f06:	6a 09                	push   $0x9
  jmp alltraps
80105f08:	e9 bd fa ff ff       	jmp    801059ca <alltraps>
...
80105f0d:	6a 0a                	push   $0xa
  jmp alltraps
80105f0f:	e9 b6 fa ff ff       	jmp    801059ca <alltraps>
...
80105f14:	6a 0b                	push   $0xb
  jmp alltraps
80105f16:	e9 af fa ff ff       	jmp    801059ca <alltraps>
...
80105f1b:	6a 0c                	push   $0xc
  jmp alltraps
80105f1d:	e9 a8 fa ff ff       	jmp    801059ca <alltraps>
...
80105f29:	6a 0e                	push   $0xe
  jmp alltraps
80105f2b:	e9 9a fa ff ff       	jmp    801059ca <alltraps>
...
80105f42:	6a 11                	push   $0x11
  jmp alltraps
80105f44:	e9 81 fa ff ff       	jmp    801059ca <alltraps>
...
80105f4b:	6a 12                	push   $0x12
  jmp alltraps
80105f4d:	e9 78 fa ff ff       	jmp    801059ca <alltraps>
...
80105f54:	6a 13                	push   $0x13
  jmp alltraps
80105f56:	e9 6f fa ff ff       	jmp    801059ca <alltraps>
...
80105f5d:	6a 14                	push   $0x14
  jmp alltraps
80105f5f:	e9 66 fa ff ff       	jmp    801059ca <alltraps>
...
80105f66:	6a 15                	push   $0x15
  jmp alltraps
80105f68:	e9 5d fa ff ff       	jmp    801059ca <alltraps>
...
80105f6f:	6a 16                	push   $0x16
  jmp alltraps
80105f71:	e9 54 fa ff ff       	jmp    801059ca <alltraps>
...
80105f78:	6a 17                	push   $0x17
  jmp alltraps
80105f7a:	e9 4b fa ff ff       	jmp    801059ca <alltraps>
...
80105f81:	6a 18                	push   $0x18
  jmp alltraps
80105f83:	e9 42 fa ff ff       	jmp    801059ca <alltraps>
...
80105f8a:	6a 19                	push   $0x19
  jmp alltraps
80105f8c:	e9 39 fa ff ff       	jmp    801059ca <alltraps>
...
80105f93:	6a 1a                	push   $0x1a
  jmp alltraps
80105f95:	e9 30 fa ff ff       	jmp    801059ca <alltraps>
...
80105f9c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f9e:	e9 27 fa ff ff       	jmp    801059ca <alltraps>
...
80105fa5:	6a 1c                	push   $0x1c
  jmp alltraps
80105fa7:	e9 1e fa ff ff       	jmp    801059ca <alltraps>
...
80105fae:	6a 1d                	push   $0x1d
  jmp alltraps
80105fb0:	e9 15 fa ff ff       	jmp    801059ca <alltraps>
...
80105fb7:	6a 1e                	push   $0x1e
  jmp alltraps
80105fb9:	e9 0c fa ff ff       	jmp    801059ca <alltraps>
...
80105fc0:	6a 1f                	push   $0x1f
  jmp alltraps
80105fc2:	e9 03 fa ff ff       	jmp    801059ca <alltraps>
...
80105fc9:	6a 20                	push   $0x20
  jmp alltraps
80105fcb:	e9 fa f9 ff ff       	jmp    801059ca <alltraps>
...
80105fd2:	6a 21                	push   $0x21
  jmp alltraps
80105fd4:	e9 f1 f9 ff ff       	jmp    801059ca <alltraps>
...
80105fdb:	6a 22                	push   $0x22
  jmp alltraps
80105fdd:	e9 e8 f9 ff ff       	jmp    801059ca <alltraps>
...
80105fe4:	6a 23                	push   $0x23
  jmp alltraps
80105fe6:	e9 df f9 ff ff       	jmp    801059ca <alltraps>
...
80105fed:	6a 24                	push   $0x24
  jmp alltraps
80105fef:	e9 d6 f9 ff ff       	jmp    801059ca <alltraps>
...
80105ff6:	6a 25                	push   $0x25
  jmp alltraps
80105ff8:	e9 cd f9 ff ff       	jmp    801059ca <alltraps>
...
80105fff:	6a 26                	push   $0x26
  jmp alltraps
80106001:	e9 c4 f9 ff ff       	jmp    801059ca <alltraps>
...
80106008:	6a 27                	push   $0x27
  jmp alltraps
8010600a:	e9 bb f9 ff ff       	jmp    801059ca <alltraps>
...
80106011:	6a 28                	push   $0x28
  jmp alltraps
80106013:	e9 b2 f9 ff ff       	jmp    801059ca <alltraps>
...
8010601a:	6a 29                	push   $0x29
  jmp alltraps
8010601c:	e9 a9 f9 ff ff       	jmp    801059ca <alltraps>
...
80106023:	6a 2a                	push   $0x2a
  jmp alltraps
80106025:	e9 a0 f9 ff ff       	jmp    801059ca <alltraps>
...
8010602c:	6a 2b                	push   $0x2b
  jmp alltraps
8010602e:	e9 97 f9 ff ff       	jmp    801059ca <alltraps>
...
80106035:	6a 2c                	push   $0x2c
  jmp alltraps
80106037:	e9 8e f9 ff ff       	jmp    801059ca <alltraps>
...
8010603e:	6a 2d                	push   $0x2d
  jmp alltraps
80106040:	e9 85 f9 ff ff       	jmp    801059ca <alltraps>
...
80106047:	6a 2e                	push   $0x2e
  jmp alltraps
80106049:	e9 7c f9 ff ff       	jmp    801059ca <alltraps>
...
80106050:	6a 2f                	push   $0x2f
  jmp alltraps
80106052:	e9 73 f9 ff ff       	jmp    801059ca <alltraps>
...
80106059:	6a 30                	push   $0x30
  jmp alltraps
8010605b:	e9 6a f9 ff ff       	jmp    801059ca <alltraps>
...
80106062:	6a 31                	push   $0x31
  jmp alltraps
80106064:	e9 61 f9 ff ff       	jmp    801059ca <alltraps>
...
8010606b:	6a 32                	push   $0x32
  jmp alltraps
8010606d:	e9 58 f9 ff ff       	jmp    801059ca <alltraps>
...
80106074:	6a 33                	push   $0x33
  jmp alltraps
80106076:	e9 4f f9 ff ff       	jmp    801059ca <alltraps>
...
8010607d:	6a 34                	push   $0x34
  jmp alltraps
8010607f:	e9 46 f9 ff ff       	jmp    801059ca <alltraps>
...
80106086:	6a 35                	push   $0x35
  jmp alltraps
80106088:	e9 3d f9 ff ff       	jmp    801059ca <alltraps>
...
8010608f:	6a 36                	push   $0x36
  jmp alltraps
80106091:	e9 34 f9 ff ff       	jmp    801059ca <alltraps>
...
80106098:	6a 37                	push   $0x37
  jmp alltraps
8010609a:	e9 2b f9 ff ff       	jmp    801059ca <alltraps>
...
801060a1:	6a 38                	push   $0x38
  jmp alltraps
801060a3:	e9 22 f9 ff ff       	jmp    801059ca <alltraps>
...
801060aa:	6a 39                	push   $0x39
  jmp alltraps
801060ac:	e9 19 f9 ff ff       	jmp    801059ca <alltraps>
...
801060b3:	6a 3a                	push   $0x3a
  jmp alltraps
801060b5:	e9 10 f9 ff ff       	jmp    801059ca <alltraps>
...
801060bc:	6a 3b                	push   $0x3b
  jmp alltraps
801060be:	e9 07 f9 ff ff       	jmp    801059ca <alltraps>
...
801060c5:	6a 3c                	push   $0x3c
  jmp alltraps
801060c7:	e9 fe f8 ff ff       	jmp    801059ca <alltraps>
...
801060ce:	6a 3d                	push   $0x3d
  jmp alltraps
801060d0:	e9 f5 f8 ff ff       	jmp    801059ca <alltraps>
...
801060d7:	6a 3e                	push   $0x3e
  jmp alltraps
801060d9:	e9 ec f8 ff ff       	jmp    801059ca <alltraps>
...
801060e0:	6a 3f                	push   $0x3f
  jmp alltraps
801060e2:	e9 e3 f8 ff ff       	jmp    801059ca <alltraps>
...
801060e9:	6a 40                	push   $0x40
  jmp alltraps
801060eb:	e9 da f8 ff ff       	jmp    801059ca <alltraps>
...
801060f2:	6a 41                	push   $0x41
  jmp alltraps
801060f4:	e9 d1 f8 ff ff       	jmp    801059ca <alltraps>
...
801060fb:	6a 42                	push   $0x42
  jmp alltraps
801060fd:	e9 c8 f8 ff ff       	jmp    801059ca <alltraps>
...
80106104:	6a 43                	push   $0x43
  jmp alltraps
80106106:	e9 bf f8 ff ff       	jmp    801059ca <alltraps>
...
8010610d:	6a 44                	push   $0x44
  jmp alltraps
8010610f:	e9 b6 f8 ff ff       	jmp    801059ca <alltraps>
...
80106116:	6a 45                	push   $0x45
  jmp alltraps
80106118:	e9 ad f8 ff ff       	jmp    801059ca <alltraps>
...
8010611f:	6a 46                	push   $0x46
  jmp alltraps
80106121:	e9 a4 f8 ff ff       	jmp    801059ca <alltraps>
...
80106128:	6a 47                	push   $0x47
  jmp alltraps
8010612a:	e9 9b f8 ff ff       	jmp    801059ca <alltraps>
...
80106131:	6a 48                	push   $0x48
  jmp alltraps
80106133:	e9 92 f8 ff ff       	jmp    801059ca <alltraps>
...
8010613a:	6a 49                	push   $0x49
  jmp alltraps
8010613c:	e9 89 f8 ff ff       	jmp    801059ca <alltraps>
...
80106143:	6a 4a                	push   $0x4a
  jmp alltraps
80106145:	e9 80 f8 ff ff       	jmp    801059ca <alltraps>
...
8010614c:	6a 4b                	push   $0x4b
  jmp alltraps
8010614e:	e9 77 f8 ff ff       	jmp    801059ca <alltraps>
...
80106155:	6a 4c                	push   $0x4c
  jmp alltraps
80106157:	e9 6e f8 ff ff       	jmp    801059ca <alltraps>
...
8010615e:	6a 4d                	push   $0x4d
  jmp alltraps
80106160:	e9 65 f8 ff ff       	jmp    801059ca <alltraps>
...
80106167:	6a 4e                	push   $0x4e
  jmp alltraps
80106169:	e9 5c f8 ff ff       	jmp    801059ca <alltraps>
...
80106170:	6a 4f                	push   $0x4f
  jmp alltraps
80106172:	e9 53 f8 ff ff       	jmp    801059ca <alltraps>
...
80106179:	6a 50                	push   $0x50
  jmp alltraps
8010617b:	e9 4a f8 ff ff       	jmp    801059ca <alltraps>
...
80106182:	6a 51                	push   $0x51
  jmp alltraps
80106184:	e9 41 f8 ff ff       	jmp    801059ca <alltraps>
...
8010618b:	6a 52                	push   $0x52
  jmp alltraps
8010618d:	e9 38 f8 ff ff       	jmp    801059ca <alltraps>
...
80106194:	6a 53                	push   $0x53
  jmp alltraps
80106196:	e9 2f f8 ff ff       	jmp    801059ca <alltraps>
...
8010619d:	6a 54                	push   $0x54
  jmp alltraps
8010619f:	e9 26 f8 ff ff       	jmp    801059ca <alltraps>
...
801061a6:	6a 55                	push   $0x55
  jmp alltraps
801061a8:	e9 1d f8 ff ff       	jmp    801059ca <alltraps>
...
801061af:	6a 56                	push   $0x56
  jmp alltraps
801061b1:	e9 14 f8 ff ff       	jmp    801059ca <alltraps>
...
801061b8:	6a 57                	push   $0x57
  jmp alltraps
801061ba:	e9 0b f8 ff ff       	jmp    801059ca <alltraps>
...
801061c1:	6a 58                	push   $0x58
  jmp alltraps
801061c3:	e9 02 f8 ff ff       	jmp    801059ca <alltraps>
...
801061ca:	6a 59                	push   $0x59
  jmp alltraps
801061cc:	e9 f9 f7 ff ff       	jmp    801059ca <alltraps>
...
801061d3:	6a 5a                	push   $0x5a
  jmp alltraps
801061d5:	e9 f0 f7 ff ff       	jmp    801059ca <alltraps>
...
801061dc:	6a 5b                	push   $0x5b
  jmp alltraps
801061de:	e9 e7 f7 ff ff       	jmp    801059ca <alltraps>
...
801061e5:	6a 5c                	push   $0x5c
  jmp alltraps
801061e7:	e9 de f7 ff ff       	jmp    801059ca <alltraps>
...
801061ee:	6a 5d                	push   $0x5d
  jmp alltraps
801061f0:	e9 d5 f7 ff ff       	jmp    801059ca <alltraps>
...
801061f7:	6a 5e                	push   $0x5e
  jmp alltraps
801061f9:	e9 cc f7 ff ff       	jmp    801059ca <alltraps>
...
80106200:	6a 5f                	push   $0x5f
  jmp alltraps
80106202:	e9 c3 f7 ff ff       	jmp    801059ca <alltraps>
...
80106209:	6a 60                	push   $0x60
  jmp alltraps
8010620b:	e9 ba f7 ff ff       	jmp    801059ca <alltraps>
...
80106212:	6a 61                	push   $0x61
  jmp alltraps
80106214:	e9 b1 f7 ff ff       	jmp    801059ca <alltraps>
...
8010621b:	6a 62                	push   $0x62
  jmp alltraps
8010621d:	e9 a8 f7 ff ff       	jmp    801059ca <alltraps>
...
80106224:	6a 63                	push   $0x63
  jmp alltraps
80106226:	e9 9f f7 ff ff       	jmp    801059ca <alltraps>
...
8010622d:	6a 64                	push   $0x64
  jmp alltraps
8010622f:	e9 96 f7 ff ff       	jmp    801059ca <alltraps>
...
80106236:	6a 65                	push   $0x65
  jmp alltraps
80106238:	e9 8d f7 ff ff       	jmp    801059ca <alltraps>
...
8010623f:	6a 66                	push   $0x66
  jmp alltraps
80106241:	e9 84 f7 ff ff       	jmp    801059ca <alltraps>
...
80106248:	6a 67                	push   $0x67
  jmp alltraps
8010624a:	e9 7b f7 ff ff       	jmp    801059ca <alltraps>
...
80106251:	6a 68                	push   $0x68
  jmp alltraps
80106253:	e9 72 f7 ff ff       	jmp    801059ca <alltraps>
...
8010625a:	6a 69                	push   $0x69
  jmp alltraps
8010625c:	e9 69 f7 ff ff       	jmp    801059ca <alltraps>
...
80106263:	6a 6a                	push   $0x6a
  jmp alltraps
80106265:	e9 60 f7 ff ff       	jmp    801059ca <alltraps>
...
8010626c:	6a 6b                	push   $0x6b
  jmp alltraps
8010626e:	e9 57 f7 ff ff       	jmp    801059ca <alltraps>
...
80106275:	6a 6c                	push   $0x6c
  jmp alltraps
80106277:	e9 4e f7 ff ff       	jmp    801059ca <alltraps>
...
8010627e:	6a 6d                	push   $0x6d
  jmp alltraps
80106280:	e9 45 f7 ff ff       	jmp    801059ca <alltraps>
...
80106287:	6a 6e                	push   $0x6e
  jmp alltraps
80106289:	e9 3c f7 ff ff       	jmp    801059ca <alltraps>
...
80106290:	6a 6f                	push   $0x6f
  jmp alltraps
80106292:	e9 33 f7 ff ff       	jmp    801059ca <alltraps>
...
80106299:	6a 70                	push   $0x70
  jmp alltraps
8010629b:	e9 2a f7 ff ff       	jmp    801059ca <alltraps>
...
801062a2:	6a 71                	push   $0x71
  jmp alltraps
801062a4:	e9 21 f7 ff ff       	jmp    801059ca <alltraps>
...
801062ab:	6a 72                	push   $0x72
  jmp alltraps
801062ad:	e9 18 f7 ff ff       	jmp    801059ca <alltraps>
...
801062b4:	6a 73                	push   $0x73
  jmp alltraps
801062b6:	e9 0f f7 ff ff       	jmp    801059ca <alltraps>
...
801062bd:	6a 74                	push   $0x74
  jmp alltraps
801062bf:	e9 06 f7 ff ff       	jmp    801059ca <alltraps>
...
801062c6:	6a 75                	push   $0x75
  jmp alltraps
801062c8:	e9 fd f6 ff ff       	jmp    801059ca <alltraps>
...
801062cf:	6a 76                	push   $0x76
  jmp alltraps
801062d1:	e9 f4 f6 ff ff       	jmp    801059ca <alltraps>
...
801062d8:	6a 77                	push   $0x77
  jmp alltraps
801062da:	e9 eb f6 ff ff       	jmp    801059ca <alltraps>
...
801062e1:	6a 78                	push   $0x78
  jmp alltraps
801062e3:	e9 e2 f6 ff ff       	jmp    801059ca <alltraps>
...
801062ea:	6a 79                	push   $0x79
  jmp alltraps
801062ec:	e9 d9 f6 ff ff       	jmp    801059ca <alltraps>
...
801062f3:	6a 7a                	push   $0x7a
  jmp alltraps
801062f5:	e9 d0 f6 ff ff       	jmp    801059ca <alltraps>
...
801062fc:	6a 7b                	push   $0x7b
  jmp alltraps
801062fe:	e9 c7 f6 ff ff       	jmp    801059ca <alltraps>
...
80106305:	6a 7c                	push   $0x7c
  jmp alltraps
80106307:	e9 be f6 ff ff       	jmp    801059ca <alltraps>
...
8010630e:	6a 7d                	push   $0x7d
  jmp alltraps
80106310:	e9 b5 f6 ff ff       	jmp    801059ca <alltraps>
...
80106317:	6a 7e                	push   $0x7e
  jmp alltraps
80106319:	e9 ac f6 ff ff       	jmp    801059ca <alltraps>
...
80106320:	6a 7f                	push   $0x7f
  jmp alltraps
80106322:	e9 a3 f6 ff ff       	jmp    801059ca <alltraps>
...
80106329:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010632e:	e9 97 f6 ff ff       	jmp    801059ca <alltraps>
...
80106335:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010633a:	e9 8b f6 ff ff       	jmp    801059ca <alltraps>
...
80106341:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106346:	e9 7f f6 ff ff       	jmp    801059ca <alltraps>
...
8010634d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106352:	e9 73 f6 ff ff       	jmp    801059ca <alltraps>
...
80106359:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010635e:	e9 67 f6 ff ff       	jmp    801059ca <alltraps>
...
80106365:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010636a:	e9 5b f6 ff ff       	jmp    801059ca <alltraps>
...
80106371:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106376:	e9 4f f6 ff ff       	jmp    801059ca <alltraps>
...
8010637d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106382:	e9 43 f6 ff ff       	jmp    801059ca <alltraps>
...
80106389:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010638e:	e9 37 f6 ff ff       	jmp    801059ca <alltraps>
...
80106395:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010639a:	e9 2b f6 ff ff       	jmp    801059ca <alltraps>
...
801063a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801063a6:	e9 1f f6 ff ff       	jmp    801059ca <alltraps>
...
801063ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801063b2:	e9 13 f6 ff ff       	jmp    801059ca <alltraps>
...
801063b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801063be:	e9 07 f6 ff ff       	jmp    801059ca <alltraps>
...
801063c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801063ca:	e9 fb f5 ff ff       	jmp    801059ca <alltraps>
...
801063d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801063d6:	e9 ef f5 ff ff       	jmp    801059ca <alltraps>
...
801063dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801063e2:	e9 e3 f5 ff ff       	jmp    801059ca <alltraps>
...
801063e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801063ee:	e9 d7 f5 ff ff       	jmp    801059ca <alltraps>
...
801063f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063fa:	e9 cb f5 ff ff       	jmp    801059ca <alltraps>
...
80106401:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106406:	e9 bf f5 ff ff       	jmp    801059ca <alltraps>
...
8010640d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106412:	e9 b3 f5 ff ff       	jmp    801059ca <alltraps>
...
80106419:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010641e:	e9 a7 f5 ff ff       	jmp    801059ca <alltraps>
...
80106425:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010642a:	e9 9b f5 ff ff       	jmp    801059ca <alltraps>
...
80106431:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106436:	e9 8f f5 ff ff       	jmp    801059ca <alltraps>
...
8010643d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106442:	e9 83 f5 ff ff       	jmp    801059ca <alltraps>
...
80106449:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010644e:	e9 77 f5 ff ff       	jmp    801059ca <alltraps>
...
80106455:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010645a:	e9 6b f5 ff ff       	jmp    801059ca <alltraps>
...
80106461:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106466:	e9 5f f5 ff ff       	jmp    801059ca <alltraps>
...
8010646d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106472:	e9 53 f5 ff ff       	jmp    801059ca <alltraps>
...
80106479:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010647e:	e9 47 f5 ff ff       	jmp    801059ca <alltraps>
...
80106485:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010648a:	e9 3b f5 ff ff       	jmp    801059ca <alltraps>
...
80106491:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106496:	e9 2f f5 ff ff       	jmp    801059ca <alltraps>
...
8010649d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801064a2:	e9 23 f5 ff ff       	jmp    801059ca <alltraps>
...
801064a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801064ae:	e9 17 f5 ff ff       	jmp    801059ca <alltraps>
...
801064b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801064ba:	e9 0b f5 ff ff       	jmp    801059ca <alltraps>
...
801064c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801064c6:	e9 ff f4 ff ff       	jmp    801059ca <alltraps>
...
801064cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801064d2:	e9 f3 f4 ff ff       	jmp    801059ca <alltraps>
...
801064d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801064de:	e9 e7 f4 ff ff       	jmp    801059ca <alltraps>
...
801064e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801064ea:	e9 db f4 ff ff       	jmp    801059ca <alltraps>
...
801064f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064f6:	e9 cf f4 ff ff       	jmp    801059ca <alltraps>
...
801064fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106502:	e9 c3 f4 ff ff       	jmp    801059ca <alltraps>
...
80106509:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010650e:	e9 b7 f4 ff ff       	jmp    801059ca <alltraps>
...
80106515:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010651a:	e9 ab f4 ff ff       	jmp    801059ca <alltraps>
...
80106521:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106526:	e9 9f f4 ff ff       	jmp    801059ca <alltraps>
...
8010652d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106532:	e9 93 f4 ff ff       	jmp    801059ca <alltraps>
...
80106539:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010653e:	e9 87 f4 ff ff       	jmp    801059ca <alltraps>
...
80106545:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010654a:	e9 7b f4 ff ff       	jmp    801059ca <alltraps>
...
80106551:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106556:	e9 6f f4 ff ff       	jmp    801059ca <alltraps>
...
8010655d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106562:	e9 63 f4 ff ff       	jmp    801059ca <alltraps>
...
80106569:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010656e:	e9 57 f4 ff ff       	jmp    801059ca <alltraps>
...
80106575:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010657a:	e9 4b f4 ff ff       	jmp    801059ca <alltraps>
...
80106581:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106586:	e9 3f f4 ff ff       	jmp    801059ca <alltraps>
...
8010658d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106592:	e9 33 f4 ff ff       	jmp    801059ca <alltraps>
...
80106599:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010659e:	e9 27 f4 ff ff       	jmp    801059ca <alltraps>
...
801065a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801065aa:	e9 1b f4 ff ff       	jmp    801059ca <alltraps>
...
801065b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801065b6:	e9 0f f4 ff ff       	jmp    801059ca <alltraps>
...
801065bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801065c2:	e9 03 f4 ff ff       	jmp    801059ca <alltraps>
...
801065c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801065ce:	e9 f7 f3 ff ff       	jmp    801059ca <alltraps>
...
801065d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801065da:	e9 eb f3 ff ff       	jmp    801059ca <alltraps>
...
801065e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801065e6:	e9 df f3 ff ff       	jmp    801059ca <alltraps>
...
801065ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065f2:	e9 d3 f3 ff ff       	jmp    801059ca <alltraps>
...
801065f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065fe:	e9 c7 f3 ff ff       	jmp    801059ca <alltraps>
...
80106605:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010660a:	e9 bb f3 ff ff       	jmp    801059ca <alltraps>
...
80106611:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106616:	e9 af f3 ff ff       	jmp    801059ca <alltraps>
...
8010661d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106622:	e9 a3 f3 ff ff       	jmp    801059ca <alltraps>
...
80106629:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010662e:	e9 97 f3 ff ff       	jmp    801059ca <alltraps>
...
80106635:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010663a:	e9 8b f3 ff ff       	jmp    801059ca <alltraps>
...
80106641:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106646:	e9 7f f3 ff ff       	jmp    801059ca <alltraps>
...
8010664d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106652:	e9 73 f3 ff ff       	jmp    801059ca <alltraps>
...
80106659:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010665e:	e9 67 f3 ff ff       	jmp    801059ca <alltraps>
...
80106665:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010666a:	e9 5b f3 ff ff       	jmp    801059ca <alltraps>
...
80106671:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106676:	e9 4f f3 ff ff       	jmp    801059ca <alltraps>
...
8010667d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106682:	e9 43 f3 ff ff       	jmp    801059ca <alltraps>
...
80106689:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010668e:	e9 37 f3 ff ff       	jmp    801059ca <alltraps>
...
80106695:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010669a:	e9 2b f3 ff ff       	jmp    801059ca <alltraps>
...
801066a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801066a6:	e9 1f f3 ff ff       	jmp    801059ca <alltraps>
...
801066ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801066b2:	e9 13 f3 ff ff       	jmp    801059ca <alltraps>
...
801066b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801066be:	e9 07 f3 ff ff       	jmp    801059ca <alltraps>
...
801066c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801066ca:	e9 fb f2 ff ff       	jmp    801059ca <alltraps>
...
801066d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801066d6:	e9 ef f2 ff ff       	jmp    801059ca <alltraps>
...
801066dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801066e2:	e9 e3 f2 ff ff       	jmp    801059ca <alltraps>
...
801066e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801066ee:	e9 d7 f2 ff ff       	jmp    801059ca <alltraps>
...
801066f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066fa:	e9 cb f2 ff ff       	jmp    801059ca <alltraps>
...
80106701:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106706:	e9 bf f2 ff ff       	jmp    801059ca <alltraps>
...
8010670d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106712:	e9 b3 f2 ff ff       	jmp    801059ca <alltraps>
...
80106719:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010671e:	e9 a7 f2 ff ff       	jmp    801059ca <alltraps>
...
80106725:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010672a:	e9 9b f2 ff ff       	jmp    801059ca <alltraps>
...
80106731:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106736:	e9 8f f2 ff ff       	jmp    801059ca <alltraps>
...
8010673d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106742:	e9 83 f2 ff ff       	jmp    801059ca <alltraps>
...
80106749:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010674e:	e9 77 f2 ff ff       	jmp    801059ca <alltraps>
...
80106755:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010675a:	e9 6b f2 ff ff       	jmp    801059ca <alltraps>
...
80106761:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106766:	e9 5f f2 ff ff       	jmp    801059ca <alltraps>
...
8010676d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106772:	e9 53 f2 ff ff       	jmp    801059ca <alltraps>
...
80106779:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010677e:	e9 47 f2 ff ff       	jmp    801059ca <alltraps>
...
80106785:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010678a:	e9 3b f2 ff ff       	jmp    801059ca <alltraps>
...
80106791:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106796:	e9 2f f2 ff ff       	jmp    801059ca <alltraps>
...
8010679d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801067a2:	e9 23 f2 ff ff       	jmp    801059ca <alltraps>
...
801067a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801067ae:	e9 17 f2 ff ff       	jmp    801059ca <alltraps>
...
801067b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801067ba:	e9 0b f2 ff ff       	jmp    801059ca <alltraps>
...
801067c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801067c6:	e9 ff f1 ff ff       	jmp    801059ca <alltraps>
...
801067cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801067d2:	e9 f3 f1 ff ff       	jmp    801059ca <alltraps>
...
801067d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801067de:	e9 e7 f1 ff ff       	jmp    801059ca <alltraps>
...
801067e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801067ea:	e9 db f1 ff ff       	jmp    801059ca <alltraps>
...
801067f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067f6:	e9 cf f1 ff ff       	jmp    801059ca <alltraps>
...
801067fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106802:	e9 c3 f1 ff ff       	jmp    801059ca <alltraps>
...
80106809:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010680e:	e9 b7 f1 ff ff       	jmp    801059ca <alltraps>
...
80106815:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010681a:	e9 ab f1 ff ff       	jmp    801059ca <alltraps>
...
80106821:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106826:	e9 9f f1 ff ff       	jmp    801059ca <alltraps>
...
8010682d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106832:	e9 93 f1 ff ff       	jmp    801059ca <alltraps>
...
80106839:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010683e:	e9 87 f1 ff ff       	jmp    801059ca <alltraps>
...
80106845:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010684a:	e9 7b f1 ff ff       	jmp    801059ca <alltraps>
...
80106851:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106856:	e9 6f f1 ff ff       	jmp    801059ca <alltraps>
...
8010685d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106862:	e9 63 f1 ff ff       	jmp    801059ca <alltraps>
...
80106869:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010686e:	e9 57 f1 ff ff       	jmp    801059ca <alltraps>
...
80106875:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010687a:	e9 4b f1 ff ff       	jmp    801059ca <alltraps>
...
80106881:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106886:	e9 3f f1 ff ff       	jmp    801059ca <alltraps>
...
8010688d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106892:	e9 33 f1 ff ff       	jmp    801059ca <alltraps>
...
80106899:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010689e:	e9 27 f1 ff ff       	jmp    801059ca <alltraps>
...
801068a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801068aa:	e9 1b f1 ff ff       	jmp    801059ca <alltraps>
...
801068b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801068b6:	e9 0f f1 ff ff       	jmp    801059ca <alltraps>
...
801068bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801068c2:	e9 03 f1 ff ff       	jmp    801059ca <alltraps>
...
801068c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801068ce:	e9 f7 f0 ff ff       	jmp    801059ca <alltraps>
...
801068d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801068da:	e9 eb f0 ff ff       	jmp    801059ca <alltraps>
...
801068e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801068e6:	e9 df f0 ff ff       	jmp    801059ca <alltraps>
...
801068ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068f2:	e9 d3 f0 ff ff       	jmp    801059ca <alltraps>
...
801068f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068fe:	e9 c7 f0 ff ff       	jmp    801059ca <alltraps>
...
80106905:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010690a:	e9 bb f0 ff ff       	jmp    801059ca <alltraps>
...
80106911:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106916:	e9 af f0 ff ff       	jmp    801059ca <alltraps>
...
8010691d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106922:	e9 a3 f0 ff ff       	jmp    801059ca <alltraps>
...
801069b9:	e8 02 bb ff ff       	call   801024c0 <kfree>
      *pte = 0;
...
801069cf:	68 86 75 10 80       	push   $0x80107586
...
80106a5e:	e8 1d bc ff ff       	call   80102680 <kalloc>
...
80106a75:	e8 e6 dc ff ff       	call   80104760 <memset>
...
80106abd:	68 d0 7b 10 80       	push   $0x80107bd0
...
80106ad3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106ad6:	e8 85 ce ff ff       	call   80103960 <cpuid>
  pd[0] = size-1;
...
80106c9b:	77 4b                	ja     80106ce8 <inituvm+0x68>
  mem = kalloc();
80106c9d:	e8 de b9 ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106caf:	e8 ac da ff ff       	call   80104760 <memset>
...
80106ce2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ce3:	e9 18 db ff ff       	jmp    80104800 <memmove>
    panic("inituvm: more than a page");
80106ce8:	83 ec 0c             	sub    $0xc,%esp
80106ceb:	68 15 7c 10 80       	push   $0x80107c15
...
80106d50:	68 2f 7c 10 80       	push   $0x80107c2f
...
80106d9e:	e8 ed ac ff ff       	call   80101a90 <readi>
...
80106dd8:	68 d0 7c 10 80       	push   $0x80107cd0
...
80106e69:	76 48                	jbe    80106eb3 <allocuvm+0xc3>
    mem = kalloc();
80106e6b:	e8 10 b8 ff ff       	call   80102680 <kalloc>
...
80106e79:	68 4d 7c 10 80       	push   $0x80107c4d
...
80106edb:	68 65 7c 10 80       	push   $0x80107c65
...
80106f00:	e8 bb b5 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106f9e:	e8 1d b5 ff ff       	call   801024c0 <kfree>
...
80106fb3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106fb4:	e9 07 b5 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80106fb9:	83 ec 0c             	sub    $0xc,%esp
80106fbc:	68 81 7c 10 80       	push   $0x80107c81
...
8010705b:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010708c:	68 92 7c 10 80       	push   $0x80107c92
...
801070de:	0f 84 b2 00 00 00    	je     80107196 <copyuvm+0xd6>
...
80107102:	68 9c 7c 10 80       	push   $0x80107c9c
...
80107160:	e8 9b d6 ff ff       	call   80104800 <memmove>
...
801071ac:	e8 0f b3 ff ff       	call   801024c0 <kfree>
      goto bad;
...
801071d7:	68 b6 7c 10 80       	push   $0x80107cb6
...
80107290:	e8 6b d5 ff ff       	call   80104800 <memmove>
    len -= n;
    buf += n;
