...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 71 05 00 00       	call   5b3 <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 90 0a 00 00       	push   $0xa90
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 5f 05 00 00       	call   5b3 <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000060 <fmtname>:
{
  ...
  94:	53                   	push   %ebx
  95:	e8 56 03 00 00       	call   3f0 <strlen>
  ...
  bd:	e8 2e 03 00 00       	call   3f0 <strlen>
  c2:	89 1c 24             	mov    %ebx,(%esp)
  return buf;
  c5:	bb 4c 0e 00 00       	mov    $0xe4c,%ebx
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
  ca:	89 c6                	mov    %eax,%esi
  cc:	e8 1f 03 00 00       	call   3f0 <strlen>
  ...
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
  e4:	e8 37 03 00 00       	call   420 <memset>
  return buf;
...
00000100 <ls>:
{
 ...
 155:	53                   	push   %ebx
 156:	e8 80 04 00 00       	call   5db <close>
 ...
 1b3:	57                   	push   %edi
 1b4:	e8 37 02 00 00       	call   3f0 <strlen>
 ...
 1d4:	57                   	push   %edi
 1d5:	e8 86 01 00 00       	call   360 <strcpy>
    p = buf+strlen(buf);
 1da:	89 3c 24             	mov    %edi,(%esp)
 1dd:	e8 0e 02 00 00       	call   3f0 <strlen>
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 b9 03 00 00       	call   5cb <read>
 ...
 24b:	56                   	push   %esi
 24c:	57                   	push   %edi
 24d:	e8 9e 02 00 00       	call   4f0 <stat>
 ...
 313:	e8 c3 02 00 00       	call   5db <close>
    return;
