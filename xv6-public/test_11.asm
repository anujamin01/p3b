   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 96 05 00 00       	call   5b3 <getpid>
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 4a 05 00 00       	call   5bb <sbrk>
  ...
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 39 0a 00 00       	push   $0xa39
  8b:	6a 01                	push   $0x1
  8d:	e8 0e 06 00 00       	call   6a0 <printf>
   exit();
  92:	e8 9c 04 00 00       	call   533 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  99:	68 c8 09 00 00       	push   $0x9c8
  9e:	68 d2 09 00 00       	push   $0x9d2
  a3:	6a 01                	push   $0x1
  a5:	e8 f6 05 00 00       	call   6a0 <printf>
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	68 07 0a 00 00       	push   $0xa07
      assert(join_pid == thread_pid);
  b2:	68 e6 09 00 00       	push   $0x9e6
  b7:	6a 01                	push   $0x1
  b9:	e8 e2 05 00 00       	call   6a0 <printf>
  be:	5a                   	pop    %edx
  bf:	59                   	pop    %ecx
  c0:	68 fa 09 00 00       	push   $0x9fa
  c5:	6a 01                	push   $0x1
  c7:	e8 d4 05 00 00       	call   6a0 <printf>
  cc:	5b                   	pop    %ebx
  cd:	ff 35 84 0e 00 00    	push   0xe84
  d3:	e8 8b 04 00 00       	call   563 <kill>
  d8:	e8 56 04 00 00       	call   533 <exit>
  dd:	6a 22                	push   $0x22
  df:	68 c8 09 00 00       	push   $0x9c8
  e4:	68 d2 09 00 00       	push   $0x9d2
  e9:	6a 01                	push   $0x1
  eb:	e8 b0 05 00 00       	call   6a0 <printf>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	68 16 0a 00 00       	push   $0xa16
  f8:	eb b8                	jmp    b2 <main+0xb2>
      assert(global == 5);
  fa:	6a 23                	push   $0x23
  fc:	68 c8 09 00 00       	push   $0x9c8
 101:	68 d2 09 00 00       	push   $0x9d2
 106:	6a 01                	push   $0x1
 108:	e8 93 05 00 00       	call   6a0 <printf>
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	68 2d 0a 00 00       	push   $0xa2d
 115:	eb 9b                	jmp    b2 <main+0xb2>
      assert((uint)sbrk(0) < (150 * 4096) && "shouldn't even come close");
 117:	6a 25                	push   $0x25
 119:	68 c8 09 00 00       	push   $0x9c8
 11e:	68 d2 09 00 00       	push   $0x9d2
 123:	6a 01                	push   $0x1
 125:	e8 76 05 00 00       	call   6a0 <printf>
 12a:	83 c4 0c             	add    $0xc,%esp
 12d:	68 48 0a 00 00       	push   $0xa48
...
worker(void *arg1, void *arg2) {
 ...
 150:	6a 2e                	push   $0x2e
 152:	68 c8 09 00 00       	push   $0x9c8
 157:	68 d2 09 00 00       	push   $0x9d2
 15c:	6a 01                	push   $0x1
 15e:	e8 3d 05 00 00       	call   6a0 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 da 09 00 00       	push   $0x9da
 16b:	68 e6 09 00 00       	push   $0x9e6
 170:	6a 01                	push   $0x1
 172:	e8 29 05 00 00       	call   6a0 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 fa 09 00 00       	push   $0x9fa
 17e:	6a 01                	push   $0x1
 180:	e8 1b 05 00 00       	call   6a0 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 84 0e 00 00    	push   0xe84
 18c:	e8 d2 03 00 00       	call   563 <kill>
 191:	e8 9d 03 00 00       	call   533 <exit>
   global += 4;
 196:	a1 80 0e 00 00       	mov    0xe80,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 80 0e 00 00       	mov    %eax,0xe80
   exit();
 1a3:	e8 8b 03 00 00       	call   533 <exit>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 1c6:	74 60                	je     228 <thread_create+0x78>
    if (inUse[i] == 0){
 1c8:	8b 04 9d a0 0e 00 00 	mov    0xea0(,%ebx,4),%eax
 1cf:	85 c0                	test   %eax,%eax
 1d1:	75 ed                	jne    1c0 <thread_create+0x10>
      void *stack = malloc(PGSIZE * 2);
 1d3:	a1 6c 0e 00 00       	mov    0xe6c,%eax
 ...
 1e3:	8b 35 6c 0e 00 00    	mov    0xe6c,%esi
 1e9:	83 c4 10             	add    $0x10,%esp
 1ec:	99                   	cltd   
      malloc_addrs[i] = stack;
 1ed:	89 04 9d a0 0f 00 00 	mov    %eax,0xfa0(,%ebx,4)
      void *stack = malloc(PGSIZE * 2);
 ...
 20b:	ff 75 08             	push   0x8(%ebp)
      stack_addrs[i] = stack;
 20e:	89 0c 9d a0 10 00 00 	mov    %ecx,0x10a0(,%ebx,4)
      return clone(start_routine,arg1,arg2,stack);
 ...
 248:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	ff 34 9d a0 0f 00 00 	push   0xfa0(,%ebx,4)
 27c:	e8 bf 05 00 00       	call   840 <free>
      inUse[i] = 0;
      break;
 281:	83 c4 10             	add    $0x10,%esp
      inUse[i] = 0;
 284:	c7 04 9d a0 0e 00 00 	movl   $0x0,0xea0(,%ebx,4)
 28b:	00 00 00 00 
    }
  }
  return id;
...
free(void *ap)
{
 ...
 841:	a1 a0 11 00 00       	mov    0x11a0,%eax
{
 ...
 881:	5b                   	pop    %ebx
  freep = p;
 882:	89 15 a0 11 00 00    	mov    %edx,0x11a0
}
 888:	5e                   	pop    %esi
 889:	5f                   	pop    %edi
 88a:	5d                   	pop    %ebp
 ...
 8b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8bc:	89 15 a0 11 00 00    	mov    %edx,0x11a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8dc:	8b 3d a0 11 00 00    	mov    0x11a0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 91f:	73 4f                	jae    970 <malloc+0xa0>
    ...
    if(p == freep)
 921:	8b 3d a0 11 00 00    	mov    0x11a0,%edi
 ...
 94a:	e8 f1 fe ff ff       	call   840 <free>
  return freep;
 94f:	8b 15 a0 11 00 00    	mov    0x11a0,%edx
 ...
 97c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 97f:	89 15 a0 11 00 00    	mov    %edx,0x11a0
}
