...
main(void)
{
  ...
  if(fork() > 0)
  11:	e8 95 03 00 00       	call   3ab <fork>
  16:	85 c0                	test   %eax,%eax
  18:	7e 0d                	jle    27 <main+0x27>
    sleep(5);  // Let child exit before parent.
  1a:	83 ec 0c             	sub    $0xc,%esp
  1d:	6a 05                	push   $0x5
  1f:	e8 1f 04 00 00       	call   443 <sleep>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  37:	eb 0f                	jmp    48 <thread_create+0x18>
  39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  40:	83 c3 01             	add    $0x1,%ebx
  43:	83 fb 40             	cmp    $0x40,%ebx
  46:	74 60                	je     a8 <thread_create+0x78>
    if (inUse[i] == 0){
  48:	8b 04 9d 20 0c 00 00 	mov    0xc20(,%ebx,4),%eax
  4f:	85 c0                	test   %eax,%eax
  51:	75 ed                	jne    40 <thread_create+0x10>
      void *stack = malloc(PGSIZE * 2);
  53:	a1 0c 0c 00 00       	mov    0xc0c,%eax
  58:	83 ec 0c             	sub    $0xc,%esp
  5b:	01 c0                	add    %eax,%eax
  5d:	50                   	push   %eax
  5e:	e8 ed 06 00 00       	call   750 <malloc>
      malloc_addrs[i] = stack;
      // if page aligned
      if ((int)stack % PGSIZE == 0){
  63:	8b 35 0c 0c 00 00    	mov    0xc0c,%esi
  69:	83 c4 10             	add    $0x10,%esp
  6c:	99                   	cltd   
      malloc_addrs[i] = stack;
  6d:	89 04 9d 20 0d 00 00 	mov    %eax,0xd20(,%ebx,4)
      void *stack = malloc(PGSIZE * 2);
  74:	89 c1                	mov    %eax,%ecx
      if ((int)stack % PGSIZE == 0){
  76:	f7 fe                	idiv   %esi
        stack += PGSIZE;
  78:	8d 04 31             	lea    (%ecx,%esi,1),%eax
  7b:	29 d6                	sub    %edx,%esi
  7d:	01 f1                	add    %esi,%ecx
  7f:	85 d2                	test   %edx,%edx
  81:	0f 44 c8             	cmove  %eax,%ecx
  ...
  8b:	ff 75 08             	push   0x8(%ebp)
      stack_addrs[i] = stack;
  8e:	89 0c 9d 20 0e 00 00 	mov    %ecx,0xe20(,%ebx,4)
      return clone(start_routine,arg1,arg2,stack);
  95:	e8 b9 03 00 00       	call   453 <clone>
  9a:	83 c4 10             	add    $0x10,%esp
    }
  } 
  return -1;
}
  9d:	8d 65 f8             	lea    -0x8(%ebp),%esp
  a0:	5b                   	pop    %ebx
  a1:	5e                   	pop    %esi
  a2:	5d                   	pop    %ebp
  a3:	c3                   	ret    
  a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  a8:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -1;
  ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
  b0:	5b                   	pop    %ebx
  b1:	5e                   	pop    %esi
  b2:	5d                   	pop    %ebp
  ...
  c8:	31 db                	xor    %ebx,%ebx
{
  ...
  int id = join(&stackAddr);
  cd:	50                   	push   %eax
  ce:	e8 88 03 00 00       	call   45b <join>
  ...
  e6:	74 27                	je     10f <thread_join+0x4f>
  ...
  f5:	ff 34 9d 20 0d 00 00 	push   0xd20(,%ebx,4)
  fc:	e8 bf 05 00 00       	call   6c0 <free>
      inUse[i] = 0;
      break;
 101:	83 c4 10             	add    $0x10,%esp
      inUse[i] = 0;
 104:	c7 04 9d 20 0c 00 00 	movl   $0x0,0xc20(,%ebx,4)
 10b:	00 00 00 00 
    }
  }
  return id;
...
void lock_release(lock_t *lock){
 ...
 158:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lock->flag, 0);
}
 15b:	5d                   	pop    %ebp
 15c:	c3                   	ret    
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 599:	ff 24 85 50 08 00 00 	jmp    *0x850(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6a7:	90                   	nop
          s = "(null)";
 6a8:	ba 48 08 00 00       	mov    $0x848,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 20 0f 00 00    	mov    %edx,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 7fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ff:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 ...
 80f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 817:	0f 00 00 
    base.s.size = 0;
 81a:	bf 24 0f 00 00       	mov    $0xf24,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 826:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 832:	00 00 00 
    if(p->s.size >= nunits){
