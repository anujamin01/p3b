...
main(int argc, char *argv[])
{
  ...
  45:	50                   	push   %eax
  46:	68 b0 0e 00 00       	push   $0xeb0
  4b:	68 b4 0e 00 00       	push   $0xeb4
  50:	68 90 01 00 00       	push   $0x190
  55:	e8 f9 05 00 00       	call   653 <clone>
   assert(clone_pid > 0);
  ...
  6e:	66 90                	xchg   %ax,%ax
   while(global != 33);
  70:	a1 ac 0e 00 00       	mov    0xeac,%eax
  75:	83 f8 21             	cmp    $0x21,%eax
  78:	75 f6                	jne    70 <main+0x70>
   assert(arg1 == 44);
  7a:	a1 b4 0e 00 00       	mov    0xeb4,%eax
  7f:	83 f8 2c             	cmp    $0x2c,%eax
  82:	75 60                	jne    e4 <main+0xe4>
   assert(arg2 == 55);
  84:	a1 b0 0e 00 00       	mov    0xeb0,%eax
  89:	83 f8 37             	cmp    $0x37,%eax
  8c:	0f 84 ac 00 00 00    	je     13e <main+0x13e>
  92:	6a 28                	push   $0x28
  94:	68 48 0a 00 00       	push   $0xa48
  99:	68 51 0a 00 00       	push   $0xa51
  9e:	6a 01                	push   $0x1
  a0:	e8 7b 06 00 00       	call   720 <printf>
  a5:	83 c4 0c             	add    $0xc,%esp
  a8:	68 a9 0a 00 00       	push   $0xaa9
   assert(clone_pid > 0);
  ad:	68 65 0a 00 00       	push   $0xa65
  b2:	6a 01                	push   $0x1
  b4:	e8 67 06 00 00       	call   720 <printf>
  b9:	5a                   	pop    %edx
  ba:	59                   	pop    %ecx
  bb:	68 79 0a 00 00       	push   $0xa79
  c0:	6a 01                	push   $0x1
  c2:	e8 59 06 00 00       	call   720 <printf>
  c7:	5b                   	pop    %ebx
  c8:	ff 35 c0 0e 00 00    	push   0xec0
  ce:	e8 10 05 00 00       	call   5e3 <kill>
  d3:	e8 db 04 00 00       	call   5b3 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  df:	e9 61 ff ff ff       	jmp    45 <main+0x45>
   assert(arg1 == 44);
  e4:	6a 27                	push   $0x27
  e6:	68 48 0a 00 00       	push   $0xa48
  eb:	68 51 0a 00 00       	push   $0xa51
  f0:	6a 01                	push   $0x1
  f2:	e8 29 06 00 00       	call   720 <printf>
  f7:	83 c4 0c             	add    $0xc,%esp
  fa:	68 9e 0a 00 00       	push   $0xa9e
  ff:	eb ac                	jmp    ad <main+0xad>
   assert(clone_pid > 0);
 101:	6a 25                	push   $0x25
 103:	68 48 0a 00 00       	push   $0xa48
 108:	68 51 0a 00 00       	push   $0xa51
 10d:	6a 01                	push   $0x1
 10f:	e8 0c 06 00 00       	call   720 <printf>
 114:	83 c4 0c             	add    $0xc,%esp
 117:	68 90 0a 00 00       	push   $0xa90
 11c:	eb 8f                	jmp    ad <main+0xad>
   assert(p != NULL);
 11e:	6a 1e                	push   $0x1e
 120:	68 48 0a 00 00       	push   $0xa48
 125:	68 51 0a 00 00       	push   $0xa51
 12a:	6a 01                	push   $0x1
 12c:	e8 ef 05 00 00       	call   720 <printf>
 131:	83 c4 0c             	add    $0xc,%esp
 134:	68 86 0a 00 00       	push   $0xa86
 139:	e9 6f ff ff ff       	jmp    ad <main+0xad>
   printf(1, "TEST PASSED\n");
 13e:	50                   	push   %eax
 13f:	50                   	push   %eax
 140:	68 b4 0a 00 00       	push   $0xab4
 145:	6a 01                	push   $0x1
 147:	e8 d4 05 00 00       	call   720 <printf>
   
   void *join_stack;
   int join_pid = join(&join_stack);
 14c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
 14f:	89 04 24             	mov    %eax,(%esp)
 152:	e8 04 05 00 00       	call   65b <join>
 ...
 174:	68 c1 0a 00 00       	push   $0xac1
 179:	e9 2f ff ff ff       	jmp    ad <main+0xad>
   free(p);
 17e:	83 ec 0c             	sub    $0xc,%esp
 181:	53                   	push   %ebx
 182:	e8 39 07 00 00       	call   8c0 <free>
   exit();
 187:	e8 27 04 00 00       	call   5b3 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1a7:	c7 00 37 00 00 00    	movl   $0x37,(%eax)
   assert(global == 1);
 1ad:	a1 ac 0e 00 00       	mov    0xeac,%eax
 1b2:	83 f8 01             	cmp    $0x1,%eax
 1b5:	74 46                	je     1fd <worker+0x6d>
 1b7:	6a 38                	push   $0x38
 1b9:	68 48 0a 00 00       	push   $0xa48
 1be:	68 51 0a 00 00       	push   $0xa51
 1c3:	6a 01                	push   $0x1
 1c5:	e8 56 05 00 00       	call   720 <printf>
 1ca:	83 c4 0c             	add    $0xc,%esp
 1cd:	68 59 0a 00 00       	push   $0xa59
 1d2:	68 65 0a 00 00       	push   $0xa65
 1d7:	6a 01                	push   $0x1
 1d9:	e8 42 05 00 00       	call   720 <printf>
 1de:	58                   	pop    %eax
 1df:	5a                   	pop    %edx
 1e0:	68 79 0a 00 00       	push   $0xa79
 1e5:	6a 01                	push   $0x1
 1e7:	e8 34 05 00 00       	call   720 <printf>
 1ec:	59                   	pop    %ecx
 1ed:	ff 35 c0 0e 00 00    	push   0xec0
 1f3:	e8 eb 03 00 00       	call   5e3 <kill>
 1f8:	e8 b6 03 00 00       	call   5b3 <exit>
   global = tmp1 + tmp2;
 1fd:	01 d9                	add    %ebx,%ecx
 1ff:	89 0d ac 0e 00 00    	mov    %ecx,0xeac
   exit();
 205:	e8 a9 03 00 00       	call   5b3 <exit>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 217:	a1 b8 0e 00 00       	mov    0xeb8,%eax
 21c:	01 c0                	add    %eax,%eax
 21e:	50                   	push   %eax
 21f:	e8 2c 07 00 00       	call   950 <malloc>
  void* original = stack;
  //Check page alignmenet
  if((uint)stack % PGSIZE != 0){
 224:	8b 0d b8 0e 00 00    	mov    0xeb8,%ecx
 ...
 242:	eb 0c                	jmp    250 <thread_create+0x40>
 244:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 248:	83 c2 01             	add    $0x1,%edx
 24b:	83 fa 40             	cmp    $0x40,%edx
 24e:	74 2f                	je     27f <thread_create+0x6f>
    if(!stack_addrs[i] && !inUse[i]){ //TODO try and change this.
 250:	8b 04 95 e0 10 00 00 	mov    0x10e0(,%edx,4),%eax
 257:	85 c0                	test   %eax,%eax
 259:	75 ed                	jne    248 <thread_create+0x38>
 25b:	8b 04 95 e0 0e 00 00 	mov    0xee0(,%edx,4),%eax
 262:	85 c0                	test   %eax,%eax
 264:	75 e2                	jne    248 <thread_create+0x38>
      inUse[i] = 1;
 266:	c7 04 95 e0 0e 00 00 	movl   $0x1,0xee0(,%edx,4)
 26d:	01 00 00 00 
      malloc_addrs[i] = original;
 271:	89 1c 95 e0 0f 00 00 	mov    %ebx,0xfe0(,%edx,4)
      stack_addrs[i] = stack;
 278:	89 0c 95 e0 10 00 00 	mov    %ecx,0x10e0(,%edx,4)
      break;
    }
  }
 ...
 289:	e8 c5 03 00 00       	call   653 <clone>
...
thread_join()
{
 ...
 2a3:	53                   	push   %ebx
  ...
  for(int i = 0; i < 64; i++){
 2a4:	31 db                	xor    %ebx,%ebx
  int threadId = join(&stackAddr);
 2a6:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 2a9:	83 ec 30             	sub    $0x30,%esp
  int threadId = join(&stackAddr);
 2ac:	50                   	push   %eax
 2ad:	e8 a9 03 00 00       	call   65b <join>
 ...
 2c6:	74 4c                	je     314 <thread_join+0x74>
    if (inUse[i] == 1 && stack_addrs[i] == stackAddr){ // if joined freer the stack 
 2c8:	83 3c 9d e0 0e 00 00 	cmpl   $0x1,0xee0(,%ebx,4)
 2cf:	01 
 2d0:	75 ee                	jne    2c0 <thread_join+0x20>
 2d2:	39 14 9d e0 10 00 00 	cmp    %edx,0x10e0(,%ebx,4)
 2d9:	75 e5                	jne    2c0 <thread_join+0x20>
      free(malloc_addrs[i]);
 2db:	83 ec 0c             	sub    $0xc,%esp
 2de:	ff 34 9d e0 0f 00 00 	push   0xfe0(,%ebx,4)
 2e5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 2e8:	e8 d3 05 00 00       	call   8c0 <free>
      malloc_addrs[i] = 0;
      stack_addrs[i] = 0;
      inUse[i] = 0;
      break;
 ...
 2f0:	83 c4 10             	add    $0x10,%esp
      malloc_addrs[i] = 0;
 2f3:	c7 04 9d e0 0f 00 00 	movl   $0x0,0xfe0(,%ebx,4)
 2fa:	00 00 00 00 
      stack_addrs[i] = 0;
 2fe:	c7 04 9d e0 10 00 00 	movl   $0x0,0x10e0(,%ebx,4)
 305:	00 00 00 00 
      inUse[i] = 0;
 309:	c7 04 9d e0 0e 00 00 	movl   $0x0,0xee0(,%ebx,4)
 310:	00 00 00 00 
    }
  }
  return threadId; 
 ...
 67c:	89 d1                	mov    %edx,%ecx
{
 ...
 6a9:	0f b6 92 38 0b 00 00 	movzbl 0xb38(%edx),%edx
 ...
 729:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 799:	ff 24 85 e0 0a 00 00 	jmp    *0xae0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8a7:	90                   	nop
          s = "(null)";
 8a8:	ba d7 0a 00 00       	mov    $0xad7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8c1:	a1 e0 11 00 00       	mov    0x11e0,%eax
{
 ...
 901:	5b                   	pop    %ebx
  freep = p;
 902:	89 15 e0 11 00 00    	mov    %edx,0x11e0
}
 908:	5e                   	pop    %esi
 909:	5f                   	pop    %edi
 90a:	5d                   	pop    %ebp
 ...
 939:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 93c:	89 15 e0 11 00 00    	mov    %edx,0x11e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 959:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 95c:	8b 3d e0 11 00 00    	mov    0x11e0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 99f:	73 4f                	jae    9f0 <malloc+0xa0>
    ...
    if(p == freep)
 9a1:	8b 3d e0 11 00 00    	mov    0x11e0,%edi
 ...
 9ca:	e8 f1 fe ff ff       	call   8c0 <free>
  return freep;
 9cf:	8b 15 e0 11 00 00    	mov    0x11e0,%edx
 ...
 9fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9ff:	89 15 e0 11 00 00    	mov    %edx,0x11e0
}
 ...
 a0f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a10:	c7 05 e0 11 00 00 e4 	movl   $0x11e4,0x11e0
 a17:	11 00 00 
    base.s.size = 0;
 a1a:	bf e4 11 00 00       	mov    $0x11e4,%edi
    base.s.ptr = freep = prevp = &base;
 a1f:	c7 05 e4 11 00 00 e4 	movl   $0x11e4,0x11e4
 a26:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a29:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a2b:	c7 05 e8 11 00 00 00 	movl   $0x0,0x11e8
 a32:	00 00 00 
    if(p->s.size >= nunits){
