   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  17:	52                   	push   %edx
  18:	52                   	push   %edx
  19:	68 98 08 00 00       	push   $0x898
  1e:	6a 02                	push   $0x2
  20:	e8 4b 05 00 00       	call   570 <printf>
    exit();
  25:	e8 d9 03 00 00       	call   403 <exit>
  }
  ...
  32:	e8 2c 04 00 00       	call   463 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 c0 03 00 00       	call   403 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  43:	ff 73 08             	push   0x8(%ebx)
  46:	ff 73 04             	push   0x4(%ebx)
  49:	68 ab 08 00 00       	push   $0x8ab
  4e:	6a 02                	push   $0x2
  50:	e8 1b 05 00 00       	call   570 <printf>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  67:	a1 74 0c 00 00       	mov    0xc74,%eax
  6c:	01 c0                	add    %eax,%eax
  6e:	50                   	push   %eax
  6f:	e8 2c 07 00 00       	call   7a0 <malloc>
  void* original = stack;
  //Check page alignmenet
  if((uint)stack % PGSIZE != 0){
  74:	8b 0d 74 0c 00 00    	mov    0xc74,%ecx
  ...
  85:	01 d9                	add    %ebx,%ecx
  87:	29 d0                	sub    %edx,%eax
  89:	01 d8                	add    %ebx,%eax
  8b:	85 d2                	test   %edx,%edx
  8d:	0f 45 c8             	cmovne %eax,%ecx
  }
  else{
    stack += PGSIZE;
  }
  ...
  92:	eb 0c                	jmp    a0 <thread_create+0x40>
  94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  98:	83 c2 01             	add    $0x1,%edx
  9b:	83 fa 40             	cmp    $0x40,%edx
  9e:	74 2f                	je     cf <thread_create+0x6f>
    if(!stack_addrs[i] && !inUse[i]){ //TODO try and change this.
  a0:	8b 04 95 80 0e 00 00 	mov    0xe80(,%edx,4),%eax
  a7:	85 c0                	test   %eax,%eax
  a9:	75 ed                	jne    98 <thread_create+0x38>
  ab:	8b 04 95 80 0c 00 00 	mov    0xc80(,%edx,4),%eax
  b2:	85 c0                	test   %eax,%eax
  b4:	75 e2                	jne    98 <thread_create+0x38>
      inUse[i] = 1;
  b6:	c7 04 95 80 0c 00 00 	movl   $0x1,0xc80(,%edx,4)
  bd:	01 00 00 00 
      malloc_addrs[i] = original;
  c1:	89 1c 95 80 0d 00 00 	mov    %ebx,0xd80(,%edx,4)
      stack_addrs[i] = stack;
  c8:	89 0c 95 80 0e 00 00 	mov    %ecx,0xe80(,%edx,4)
      break;
    }
  }
  int threadId = clone(start_routine, arg1, arg2, stack);
  cf:	51                   	push   %ecx
  d0:	ff 75 10             	push   0x10(%ebp)
  d3:	ff 75 0c             	push   0xc(%ebp)
  d6:	ff 75 08             	push   0x8(%ebp)
  d9:	e8 c5 03 00 00       	call   4a3 <clone>
...
thread_join()
{
  ...
  int threadId = join(&stackAddr);
  f6:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
  f9:	83 ec 30             	sub    $0x30,%esp
  int threadId = join(&stackAddr);
  fc:	50                   	push   %eax
  fd:	e8 a9 03 00 00       	call   4ab <join>
    if (inUse[i] == 1 && stack_addrs[i] == stackAddr){ // if joined freer the stack 
 102:	8b 55 f4             	mov    -0xc(%ebp),%edx
 105:	83 c4 10             	add    $0x10,%esp
 108:	eb 0e                	jmp    118 <thread_join+0x28>
 10a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(int i = 0; i < 64; i++){
 110:	83 c3 01             	add    $0x1,%ebx
 113:	83 fb 40             	cmp    $0x40,%ebx
 116:	74 4c                	je     164 <thread_join+0x74>
    if (inUse[i] == 1 && stack_addrs[i] == stackAddr){ // if joined freer the stack 
 118:	83 3c 9d 80 0c 00 00 	cmpl   $0x1,0xc80(,%ebx,4)
 11f:	01 
 120:	75 ee                	jne    110 <thread_join+0x20>
 122:	39 14 9d 80 0e 00 00 	cmp    %edx,0xe80(,%ebx,4)
 129:	75 e5                	jne    110 <thread_join+0x20>
      free(malloc_addrs[i]);
 12b:	83 ec 0c             	sub    $0xc,%esp
 12e:	ff 34 9d 80 0d 00 00 	push   0xd80(,%ebx,4)
 135:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 138:	e8 d3 05 00 00       	call   710 <free>
      malloc_addrs[i] = 0;
      stack_addrs[i] = 0;
      inUse[i] = 0;
      break;
 ...
 140:	83 c4 10             	add    $0x10,%esp
      malloc_addrs[i] = 0;
 143:	c7 04 9d 80 0d 00 00 	movl   $0x0,0xd80(,%ebx,4)
 14a:	00 00 00 00 
      stack_addrs[i] = 0;
 14e:	c7 04 9d 80 0e 00 00 	movl   $0x0,0xe80(,%ebx,4)
 155:	00 00 00 00 
      inUse[i] = 0;
 159:	c7 04 9d 80 0c 00 00 	movl   $0x0,0xc80(,%ebx,4)
 160:	00 00 00 00 
    }
  }
  return threadId; 
...
xchg(volatile uint *addr, uint newval)
{
 ...
 181:	b9 01 00 00 00       	mov    $0x1,%ecx
 ...
 197:	75 f7                	jne    190 <lock_acquire+0x10>
}
 199:	5d                   	pop    %ebp
 19a:	c3                   	ret    
...
void lock_release(lock_t *lock){
 ...
 1a8:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lock->flag, 0);
}
 1ab:	5d                   	pop    %ebp
 1ac:	c3                   	ret    
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 20 09 00 00 	movzbl 0x920(%edx),%edx
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e9:	ff 24 85 c8 08 00 00 	jmp    *0x8c8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba bf 08 00 00       	mov    $0x8bf,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 80 0f 00 00       	mov    0xf80,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 80 0f 00 00    	mov    %edx,0xf80
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 80 0f 00 00    	mov    %edx,0xf80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d 80 0f 00 00    	mov    0xf80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d 80 0f 00 00    	mov    0xf80,%edi
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 80 0f 00 00    	mov    0xf80,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 80 0f 00 00    	mov    %edx,0xf80
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 80 0f 00 00 84 	movl   $0xf84,0xf80
 867:	0f 00 00 
    base.s.size = 0;
 86a:	bf 84 0f 00 00       	mov    $0xf84,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 84 0f 00 00 84 	movl   $0xf84,0xf84
 876:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 88 0f 00 00 00 	movl   $0x0,0xf88
 882:	00 00 00 
    if(p->s.size >= nunits){
