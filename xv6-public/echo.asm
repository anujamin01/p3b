...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  77:	a1 6c 0c 00 00       	mov    0xc6c,%eax
  7c:	01 c0                	add    %eax,%eax
  7e:	50                   	push   %eax
  7f:	e8 2c 07 00 00       	call   7b0 <malloc>
  void* original = stack;
  //Check page alignmenet
  if((uint)stack % PGSIZE != 0){
  84:	8b 0d 6c 0c 00 00    	mov    0xc6c,%ecx
  ...
  95:	01 d9                	add    %ebx,%ecx
  97:	29 d0                	sub    %edx,%eax
  99:	01 d8                	add    %ebx,%eax
  9b:	85 d2                	test   %edx,%edx
  9d:	0f 45 c8             	cmovne %eax,%ecx
  }
  else{
    stack += PGSIZE;
  }
  ...
  a2:	eb 0c                	jmp    b0 <thread_create+0x40>
  a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  a8:	83 c2 01             	add    $0x1,%edx
  ab:	83 fa 40             	cmp    $0x40,%edx
  ae:	74 2f                	je     df <thread_create+0x6f>
    if(!stack_addrs[i] && !inUse[i]){ //TODO try and change this.
  b0:	8b 04 95 80 0e 00 00 	mov    0xe80(,%edx,4),%eax
  b7:	85 c0                	test   %eax,%eax
  b9:	75 ed                	jne    a8 <thread_create+0x38>
  bb:	8b 04 95 80 0c 00 00 	mov    0xc80(,%edx,4),%eax
  c2:	85 c0                	test   %eax,%eax
  c4:	75 e2                	jne    a8 <thread_create+0x38>
      inUse[i] = 1;
  c6:	c7 04 95 80 0c 00 00 	movl   $0x1,0xc80(,%edx,4)
  cd:	01 00 00 00 
      malloc_addrs[i] = original;
  d1:	89 1c 95 80 0d 00 00 	mov    %ebx,0xd80(,%edx,4)
      stack_addrs[i] = stack;
  d8:	89 0c 95 80 0e 00 00 	mov    %ecx,0xe80(,%edx,4)
      break;
    }
  }
  int threadId = clone(start_routine, arg1, arg2, stack);
  df:	51                   	push   %ecx
  e0:	ff 75 10             	push   0x10(%ebp)
  e3:	ff 75 0c             	push   0xc(%ebp)
  e6:	ff 75 08             	push   0x8(%ebp)
  e9:	e8 c5 03 00 00       	call   4b3 <clone>
...
thread_join()
{
 ...
 104:	31 db                	xor    %ebx,%ebx
  int threadId = join(&stackAddr);
 106:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 109:	83 ec 30             	sub    $0x30,%esp
  int threadId = join(&stackAddr);
 10c:	50                   	push   %eax
 10d:	e8 a9 03 00 00       	call   4bb <join>
    if (inUse[i] == 1 && stack_addrs[i] == stackAddr){ // if joined freer the stack 
 112:	8b 55 f4             	mov    -0xc(%ebp),%edx
 ...
 126:	74 4c                	je     174 <thread_join+0x74>
    if (inUse[i] == 1 && stack_addrs[i] == stackAddr){ // if joined freer the stack 
 128:	83 3c 9d 80 0c 00 00 	cmpl   $0x1,0xc80(,%ebx,4)
 12f:	01 
 130:	75 ee                	jne    120 <thread_join+0x20>
 132:	39 14 9d 80 0e 00 00 	cmp    %edx,0xe80(,%ebx,4)
 139:	75 e5                	jne    120 <thread_join+0x20>
      free(malloc_addrs[i]);
 13b:	83 ec 0c             	sub    $0xc,%esp
 13e:	ff 34 9d 80 0d 00 00 	push   0xd80(,%ebx,4)
 145:	89 45 e4             	mov    %eax,-0x1c(%ebp)
 148:	e8 d3 05 00 00       	call   720 <free>
      malloc_addrs[i] = 0;
      stack_addrs[i] = 0;
      inUse[i] = 0;
      break;
 ...
 150:	83 c4 10             	add    $0x10,%esp
      malloc_addrs[i] = 0;
 153:	c7 04 9d 80 0d 00 00 	movl   $0x0,0xd80(,%ebx,4)
 15a:	00 00 00 00 
      stack_addrs[i] = 0;
 15e:	c7 04 9d 80 0e 00 00 	movl   $0x0,0xe80(,%ebx,4)
 165:	00 00 00 00 
      inUse[i] = 0;
 169:	c7 04 9d 80 0c 00 00 	movl   $0x0,0xc80(,%ebx,4)
 170:	00 00 00 00 
    }
  }
  return threadId; 
...
void lock_release(lock_t *lock){
 ...
 1b8:	f0 87 02             	lock xchg %eax,(%edx)
  xchg(&lock->flag, 0);
}
 1bb:	5d                   	pop    %ebp
 1bc:	c3                   	ret    
