...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 bc 05 00 00       	call   5d3 <getpid>
  ...
  91:	68 4c 0a 00 00       	push   $0xa4c
  96:	68 05 0a 00 00       	push   $0xa05
  9b:	6a 01                	push   $0x1
  9d:	e8 1e 06 00 00       	call   6c0 <printf>
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 19 0a 00 00       	push   $0xa19
  a9:	6a 01                	push   $0x1
  ab:	e8 10 06 00 00       	call   6c0 <printf>
  b0:	5b                   	pop    %ebx
  b1:	ff 35 60 0e 00 00    	push   0xe60
  b7:	e8 c7 04 00 00       	call   583 <kill>
  bc:	e8 92 04 00 00       	call   553 <exit>
   assert(thread_pid > 0);
  c1:	6a 1e                	push   $0x1e
  ...
  d7:	68 3d 0a 00 00       	push   $0xa3d
  dc:	eb b8                	jmp    96 <main+0x96>

   printf(1, "TEST PASSED\n");
  de:	50                   	push   %eax
  df:	50                   	push   %eax
  e0:	68 6f 0a 00 00       	push   $0xa6f
  e5:	6a 01                	push   $0x1
  e7:	e8 d4 05 00 00       	call   6c0 <printf>
   exit();
  ec:	e8 62 04 00 00       	call   553 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 12c:	c3                   	ret    
   assert(tmp1 == 42);
 12d:	6a 2c                	push   $0x2c
 12f:	68 e8 09 00 00       	push   $0x9e8
 134:	68 f2 09 00 00       	push   $0x9f2
 139:	6a 01                	push   $0x1
 13b:	e8 80 05 00 00       	call   6c0 <printf>
 140:	83 c4 0c             	add    $0xc,%esp
 143:	68 fa 09 00 00       	push   $0x9fa
   assert(tmp2 == 24);
 148:	68 05 0a 00 00       	push   $0xa05
 14d:	6a 01                	push   $0x1
 14f:	e8 6c 05 00 00       	call   6c0 <printf>
 154:	58                   	pop    %eax
 155:	5a                   	pop    %edx
 156:	68 19 0a 00 00       	push   $0xa19
 15b:	6a 01                	push   $0x1
 15d:	e8 5e 05 00 00       	call   6c0 <printf>
 162:	59                   	pop    %ecx
 163:	ff 35 60 0e 00 00    	push   0xe60
 169:	e8 15 04 00 00       	call   583 <kill>
 16e:	e8 e0 03 00 00       	call   553 <exit>
   assert(global == 1);
 173:	6a 2e                	push   $0x2e
 175:	68 e8 09 00 00       	push   $0x9e8
 17a:	68 f2 09 00 00       	push   $0x9f2
 17f:	6a 01                	push   $0x1
 181:	e8 3a 05 00 00       	call   6c0 <printf>
 186:	83 c4 0c             	add    $0xc,%esp
 189:	68 31 0a 00 00       	push   $0xa31
 18e:	eb b8                	jmp    148 <worker+0x48>
   assert(tmp2 == 24);
 190:	6a 2d                	push   $0x2d
 192:	68 e8 09 00 00       	push   $0x9e8
 197:	68 f2 09 00 00       	push   $0x9f2
 19c:	6a 01                	push   $0x1
 19e:	e8 1d 05 00 00       	call   6c0 <printf>
 1a3:	83 c4 0c             	add    $0xc,%esp
 1a6:	68 26 0a 00 00       	push   $0xa26
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 1b7:	a1 58 0e 00 00       	mov    0xe58,%eax
 ...
 1c4:	8b 0d 58 0e 00 00    	mov    0xe58,%ecx
 ...
 1f0:	8b 04 95 80 10 00 00 	mov    0x1080(,%edx,4),%eax
 1f7:	85 c0                	test   %eax,%eax
 1f9:	75 ed                	jne    1e8 <thread_create+0x38>
 1fb:	8b 04 95 80 0e 00 00 	mov    0xe80(,%edx,4),%eax
 202:	85 c0                	test   %eax,%eax
 204:	75 e2                	jne    1e8 <thread_create+0x38>
      inUse[i] = 1;
 206:	c7 04 95 80 0e 00 00 	movl   $0x1,0xe80(,%edx,4)
 20d:	01 00 00 00 
      malloc_addrs[i] = original;
 211:	89 1c 95 80 0f 00 00 	mov    %ebx,0xf80(,%edx,4)
      stack_addrs[i] = stack;
 218:	89 0c 95 80 10 00 00 	mov    %ecx,0x1080(,%edx,4)
      break;
    }
  }
 ...
 246:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
 ...
 272:	39 14 9d 80 10 00 00 	cmp    %edx,0x1080(,%ebx,4)
 279:	75 e5                	jne    260 <thread_join+0x20>
      free(malloc_addrs[i]);
 27b:	83 ec 0c             	sub    $0xc,%esp
 27e:	ff 34 9d 80 0f 00 00 	push   0xf80(,%ebx,4)
 ...
 290:	83 c4 10             	add    $0x10,%esp
      malloc_addrs[i] = 0;
 293:	c7 04 9d 80 0f 00 00 	movl   $0x0,0xf80(,%ebx,4)
 29a:	00 00 00 00 
      stack_addrs[i] = 0;
 29e:	c7 04 9d 80 10 00 00 	movl   $0x0,0x1080(,%ebx,4)
 2a5:	00 00 00 00 
      inUse[i] = 0;
 2a9:	c7 04 9d 80 0e 00 00 	movl   $0x0,0xe80(,%ebx,4)
 2b0:	00 00 00 00 
    }
  }
  return threadId; 
 ...
 61c:	89 d1                	mov    %edx,%ecx
{
 ...
 649:	0f b6 92 dc 0a 00 00 	movzbl 0xadc(%edx),%edx
 ...
 6c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 739:	ff 24 85 84 0a 00 00 	jmp    *0xa84(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 847:	90                   	nop
          s = "(null)";
 848:	ba 7c 0a 00 00       	mov    $0xa7c,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 861:	a1 80 11 00 00       	mov    0x1180,%eax
{
 ...
 8a1:	5b                   	pop    %ebx
  freep = p;
 8a2:	89 15 80 11 00 00    	mov    %edx,0x1180
}
 8a8:	5e                   	pop    %esi
 8a9:	5f                   	pop    %edi
 8aa:	5d                   	pop    %ebp
 ...
 8d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8dc:	89 15 80 11 00 00    	mov    %edx,0x1180
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 8f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 8fc:	8b 3d 80 11 00 00    	mov    0x1180,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 93f:	73 4f                	jae    990 <malloc+0xa0>
    ...
    if(p == freep)
 941:	8b 3d 80 11 00 00    	mov    0x1180,%edi
 ...
 96a:	e8 f1 fe ff ff       	call   860 <free>
  return freep;
 96f:	8b 15 80 11 00 00    	mov    0x1180,%edx
 ...
 99c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 99f:	89 15 80 11 00 00    	mov    %edx,0x1180
}
 ...
 9af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9b0:	c7 05 80 11 00 00 84 	movl   $0x1184,0x1180
 9b7:	11 00 00 
    base.s.size = 0;
 9ba:	bf 84 11 00 00       	mov    $0x1184,%edi
    base.s.ptr = freep = prevp = &base;
 9bf:	c7 05 84 11 00 00 84 	movl   $0x1184,0x1184
 9c6:	11 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9cb:	c7 05 88 11 00 00 00 	movl   $0x0,0x1188
 9d2:	00 00 00 
    if(p->s.size >= nunits){
