...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 2f 06 00 00       	call   643 <getpid>
  ...
  1c:	a3 28 0f 00 00       	mov    %eax,0xf28
   lock_init(&lock);
  21:	e8 0a 03 00 00       	call   330 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 04 0f 00 00       	mov    0xf04,%eax
  ...
  40:	a1 04 0f 00 00       	mov    0xf04,%eax
  ...
  70:	6a 01                	push   $0x1
  72:	e8 b9 06 00 00       	call   730 <printf>
  ...
  84:	6a 01                	push   $0x1
  86:	e8 a5 06 00 00       	call   730 <printf>
  8b:	5a                   	pop    %edx
  8c:	59                   	pop    %ecx
  8d:	68 94 0a 00 00       	push   $0xa94
  92:	6a 01                	push   $0x1
  94:	e8 97 06 00 00       	call   730 <printf>
  99:	5b                   	pop    %ebx
  9a:	ff 35 28 0f 00 00    	push   0xf28
  a0:	e8 4e 05 00 00       	call   5f3 <kill>
  a5:	e8 19 05 00 00       	call   5c3 <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 04 0f 00 00       	mov    0xf04,%eax
  ...
  cd:	6a 2b                	push   $0x2b
  cf:	68 58 0a 00 00       	push   $0xa58
  d4:	68 62 0a 00 00       	push   $0xa62
  d9:	6a 01                	push   $0x1
  db:	e8 50 06 00 00       	call   730 <printf>
  e0:	83 c4 0c             	add    $0xc,%esp
  e3:	68 a8 0a 00 00       	push   $0xaa8
  ...
  f4:	6a 2e                	push   $0x2e
  f6:	68 58 0a 00 00       	push   $0xa58
  fb:	68 62 0a 00 00       	push   $0xa62
 100:	6a 01                	push   $0x1
 102:	e8 29 06 00 00       	call   730 <printf>
 107:	83 c4 0c             	add    $0xc,%esp
 10a:	68 b5 0a 00 00       	push   $0xab5
 ...
 11d:	e8 0e 06 00 00       	call   730 <printf>
   exit();
 122:	e8 9c 04 00 00       	call   5c3 <exit>
...
void worker2(void *arg1,void *arg2){
 ...
 13b:	e8 00 02 00 00       	call   340 <lock_acquire>
    for(j=0;j<50;j++);
    global++;
    lock_release(&lock);
 ...
 147:	83 05 24 0f 00 00 01 	addl   $0x1,0xf24
    lock_release(&lock);
 14e:	e8 0d 02 00 00       	call   360 <lock_release>
    exit();
 153:	e8 6b 04 00 00       	call   5c3 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 16c:	e8 cf 01 00 00       	call   340 <lock_acquire>
    int j;
 ...
 178:	83 05 24 0f 00 00 01 	addl   $0x1,0xf24
    lock_release(&lock);
 17f:	e8 dc 01 00 00       	call   360 <lock_release>
 ...
 1af:	6a 4b                	push   $0x4b
 1b1:	68 58 0a 00 00       	push   $0xa58
 1b6:	68 62 0a 00 00       	push   $0xa62
 1bb:	6a 01                	push   $0x1
 1bd:	e8 6e 05 00 00       	call   730 <printf>
 1c2:	83 c4 0c             	add    $0xc,%esp
 1c5:	68 dc 0a 00 00       	push   $0xadc
    assert(nested_join_pid > 0);
 1ca:	68 80 0a 00 00       	push   $0xa80
 1cf:	6a 01                	push   $0x1
 1d1:	e8 5a 05 00 00       	call   730 <printf>
 1d6:	58                   	pop    %eax
 1d7:	5a                   	pop    %edx
 1d8:	68 94 0a 00 00       	push   $0xa94
 1dd:	6a 01                	push   $0x1
 1df:	e8 4c 05 00 00       	call   730 <printf>
 1e4:	59                   	pop    %ecx
 1e5:	ff 35 28 0f 00 00    	push   0xf28
 1eb:	e8 03 04 00 00       	call   5f3 <kill>
 1f0:	e8 ce 03 00 00       	call   5c3 <exit>
    assert(nested_thread_pid > 0);
 1f5:	6a 47                	push   $0x47
 1f7:	68 58 0a 00 00       	push   $0xa58
 1fc:	68 62 0a 00 00       	push   $0xa62
 201:	6a 01                	push   $0x1
 203:	e8 28 05 00 00       	call   730 <printf>
 208:	83 c4 0c             	add    $0xc,%esp
 20b:	68 6a 0a 00 00       	push   $0xa6a
 210:	eb b8                	jmp    1ca <worker+0x6a>
    assert(nested_join_pid > 0);
 212:	6a 49                	push   $0x49
 214:	68 58 0a 00 00       	push   $0xa58
 219:	68 62 0a 00 00       	push   $0xa62
 21e:	6a 01                	push   $0x1
 220:	e8 0b 05 00 00       	call   730 <printf>
 225:	83 c4 0c             	add    $0xc,%esp
 228:	68 a1 0a 00 00       	push   $0xaa1
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 256:	74 60                	je     2b8 <thread_create+0x78>
    if (inUse[i] == 0){
 258:	8b 04 9d 40 0f 00 00 	mov    0xf40(,%ebx,4),%eax
 25f:	85 c0                	test   %eax,%eax
 261:	75 ed                	jne    250 <thread_create+0x10>
      void *stack = malloc(PGSIZE * 2);
 263:	a1 08 0f 00 00       	mov    0xf08,%eax
 ...
 273:	8b 35 08 0f 00 00    	mov    0xf08,%esi
 279:	83 c4 10             	add    $0x10,%esp
 27c:	99                   	cltd   
      malloc_addrs[i] = stack;
 27d:	89 04 9d 40 10 00 00 	mov    %eax,0x1040(,%ebx,4)
      void *stack = malloc(PGSIZE * 2);
 ...
 29b:	ff 75 08             	push   0x8(%ebp)
      stack_addrs[i] = stack;
 29e:	89 0c 9d 40 11 00 00 	mov    %ecx,0x1140(,%ebx,4)
      return clone(start_routine,arg1,arg2,stack);
 ...
 2d8:	31 db                	xor    %ebx,%ebx
{
 ...
 305:	ff 34 9d 40 10 00 00 	push   0x1040(,%ebx,4)
 30c:	e8 bf 05 00 00       	call   8d0 <free>
      inUse[i] = 0;
      break;
 311:	83 c4 10             	add    $0x10,%esp
      inUse[i] = 0;
 314:	c7 04 9d 40 0f 00 00 	movl   $0x0,0xf40(,%ebx,4)
 31b:	00 00 00 00 
    }
  }
  return id;
 ...
 68c:	89 d1                	mov    %edx,%ecx
{
 ...
 6b9:	0f b6 92 60 0b 00 00 	movzbl 0xb60(%edx),%edx
 ...
 739:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7a9:	ff 24 85 08 0b 00 00 	jmp    *0xb08(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8b7:	90                   	nop
          s = "(null)";
 8b8:	ba ff 0a 00 00       	mov    $0xaff,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 8d1:	a1 40 12 00 00       	mov    0x1240,%eax
{
 ...
 911:	5b                   	pop    %ebx
  freep = p;
 912:	89 15 40 12 00 00    	mov    %edx,0x1240
}
 918:	5e                   	pop    %esi
 919:	5f                   	pop    %edi
 91a:	5d                   	pop    %ebp
 ...
 949:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 94c:	89 15 40 12 00 00    	mov    %edx,0x1240
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 969:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 96c:	8b 3d 40 12 00 00    	mov    0x1240,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9af:	73 4f                	jae    a00 <malloc+0xa0>
    ...
    if(p == freep)
 9b1:	8b 3d 40 12 00 00    	mov    0x1240,%edi
 ...
 9da:	e8 f1 fe ff ff       	call   8d0 <free>
  return freep;
 9df:	8b 15 40 12 00 00    	mov    0x1240,%edx
 ...
 a0c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a0f:	89 15 40 12 00 00    	mov    %edx,0x1240
}
 ...
 a1f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a20:	c7 05 40 12 00 00 44 	movl   $0x1244,0x1240
 a27:	12 00 00 
    base.s.size = 0;
 a2a:	bf 44 12 00 00       	mov    $0x1244,%edi
    base.s.ptr = freep = prevp = &base;
 a2f:	c7 05 44 12 00 00 44 	movl   $0x1244,0x1244
 a36:	12 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a39:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a3b:	c7 05 48 12 00 00 00 	movl   $0x0,0x1248
 a42:	00 00 00 
    if(p->s.size >= nunits){
