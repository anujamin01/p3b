...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 4a 06 00 00       	call   663 <getpid>

   void *stack, *p = malloc(PGSIZE * 2);
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  21:	a3 20 0f 00 00       	mov    %eax,0xf20
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  60:	c7 45 e0 18 00 00 00 	movl   $0x18,-0x20(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  67:	e8 17 06 00 00       	call   683 <clone>
   assert(clone_pid > 0);
  ...
  7b:	50                   	push   %eax
  7c:	e8 0a 06 00 00       	call   68b <join>
  ...
  8f:	68 81 0a 00 00       	push   $0xa81
  94:	6a 01                	push   $0x1
  96:	e8 b5 06 00 00       	call   750 <printf>
  9b:	83 c4 0c             	add    $0xc,%esp
  9e:	68 e4 0a 00 00       	push   $0xae4
   assert(clone_pid > 0);
  a3:	68 94 0a 00 00       	push   $0xa94
  a8:	6a 01                	push   $0x1
  aa:	e8 a1 06 00 00       	call   750 <printf>
  af:	5a                   	pop    %edx
  b0:	59                   	pop    %ecx
  b1:	68 a8 0a 00 00       	push   $0xaa8
  b6:	6a 01                	push   $0x1
  b8:	e8 93 06 00 00       	call   750 <printf>
  bd:	5b                   	pop    %ebx
  be:	ff 35 20 0f 00 00    	push   0xf20
  c4:	e8 4a 05 00 00       	call   613 <kill>
  c9:	e8 15 05 00 00       	call   5e3 <exit>
  ce:	6a 25                	push   $0x25
  d0:	68 78 0a 00 00       	push   $0xa78
  d5:	68 81 0a 00 00       	push   $0xa81
  da:	6a 01                	push   $0x1
  dc:	e8 6f 06 00 00       	call   750 <printf>
  e1:	83 c4 0c             	add    $0xc,%esp
  e4:	68 d6 0a 00 00       	push   $0xad6
  e9:	eb b8                	jmp    a3 <main+0xa3>
   assert(stack == join_stack);
  eb:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
  ee:	74 1d                	je     10d <main+0x10d>
  f0:	6a 2a                	push   $0x2a
  f2:	68 78 0a 00 00       	push   $0xa78
  f7:	68 81 0a 00 00       	push   $0xa81
  fc:	6a 01                	push   $0x1
  fe:	e8 4d 06 00 00       	call   750 <printf>
 103:	83 c4 0c             	add    $0xc,%esp
 106:	68 fa 0a 00 00       	push   $0xafa
 10b:	eb 96                	jmp    a3 <main+0xa3>
   assert(global == 2);
 10d:	83 3d 00 0f 00 00 02 	cmpl   $0x2,0xf00
 114:	74 40                	je     156 <main+0x156>
 116:	6a 2b                	push   $0x2b
 118:	68 78 0a 00 00       	push   $0xa78
 11d:	68 81 0a 00 00       	push   $0xa81
 122:	6a 01                	push   $0x1
 124:	e8 27 06 00 00       	call   750 <printf>
 129:	83 c4 0c             	add    $0xc,%esp
 12c:	68 0e 0b 00 00       	push   $0xb0e
 131:	e9 6d ff ff ff       	jmp    a3 <main+0xa3>
   assert(p != NULL);
 136:	6a 1d                	push   $0x1d
 138:	68 78 0a 00 00       	push   $0xa78
 13d:	68 81 0a 00 00       	push   $0xa81
 142:	6a 01                	push   $0x1
 144:	e8 07 06 00 00       	call   750 <printf>
 149:	83 c4 0c             	add    $0xc,%esp
 14c:	68 cc 0a 00 00       	push   $0xacc
 ...
 15d:	6a 01                	push   $0x1
 15f:	e8 ec 05 00 00       	call   750 <printf>
   free(p);
 164:	89 1c 24             	mov    %ebx,(%esp)
 167:	e8 84 07 00 00       	call   8f0 <free>
   exit();
 16c:	e8 72 04 00 00       	call   5e3 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1a5:	6a 38                	push   $0x38
 1a7:	68 78 0a 00 00       	push   $0xa78
 1ac:	68 81 0a 00 00       	push   $0xa81
 1b1:	6a 01                	push   $0x1
 1b3:	e8 98 05 00 00       	call   750 <printf>
 1b8:	83 c4 0c             	add    $0xc,%esp
 1bb:	68 c0 0a 00 00       	push   $0xac0
 1c0:	eb 1b                	jmp    1dd <worker+0x5d>
   assert(tmp2 == 24);
 1c2:	6a 37                	push   $0x37
 1c4:	68 78 0a 00 00       	push   $0xa78
 1c9:	68 81 0a 00 00       	push   $0xa81
 1ce:	6a 01                	push   $0x1
 1d0:	e8 7b 05 00 00       	call   750 <printf>
 1d5:	83 c4 0c             	add    $0xc,%esp
 1d8:	68 b5 0a 00 00       	push   $0xab5
 1dd:	68 94 0a 00 00       	push   $0xa94
 1e2:	6a 01                	push   $0x1
 1e4:	e8 67 05 00 00       	call   750 <printf>
 1e9:	58                   	pop    %eax
 1ea:	5a                   	pop    %edx
 1eb:	68 a8 0a 00 00       	push   $0xaa8
 1f0:	6a 01                	push   $0x1
 1f2:	e8 59 05 00 00       	call   750 <printf>
 1f7:	59                   	pop    %ecx
 1f8:	ff 35 20 0f 00 00    	push   0xf20
 1fe:	e8 10 04 00 00       	call   613 <kill>
 203:	e8 db 03 00 00       	call   5e3 <exit>
   assert(tmp1 == 42);
 208:	6a 36                	push   $0x36
 20a:	68 78 0a 00 00       	push   $0xa78
 20f:	68 81 0a 00 00       	push   $0xa81
 214:	6a 01                	push   $0x1
 216:	e8 35 05 00 00       	call   750 <printf>
 21b:	83 c4 0c             	add    $0xc,%esp
 21e:	68 89 0a 00 00       	push   $0xa89
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
 ...
 247:	a1 04 0f 00 00       	mov    0xf04,%eax
 ...
 254:	8b 0d 04 0f 00 00    	mov    0xf04,%ecx
 ...
 6ac:	89 d1                	mov    %edx,%ecx
{
 ...
 6d9:	0f b6 92 88 0b 00 00 	movzbl 0xb88(%edx),%edx
 ...
 759:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7c9:	ff 24 85 30 0b 00 00 	jmp    *0xb30(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 8d7:	90                   	nop
          s = "(null)";
 8d8:	ba 27 0b 00 00       	mov    $0xb27,%edx
        while(*s != 0){
