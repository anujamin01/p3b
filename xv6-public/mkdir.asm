...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 31 04 00 00       	call   46b <mkdir>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  96:	74 60                	je     f8 <thread_create+0x78>
    if (inUse[i] == 0){
  98:	8b 04 9d c0 0c 00 00 	mov    0xcc0(,%ebx,4),%eax
  9f:	85 c0                	test   %eax,%eax
  a1:	75 ed                	jne    90 <thread_create+0x10>
      void *stack = malloc(PGSIZE * 2);
  a3:	a1 a0 0c 00 00       	mov    0xca0,%eax
  ...
  b3:	8b 35 a0 0c 00 00    	mov    0xca0,%esi
  b9:	83 c4 10             	add    $0x10,%esp
  bc:	99                   	cltd   
      malloc_addrs[i] = stack;
  bd:	89 04 9d c0 0d 00 00 	mov    %eax,0xdc0(,%ebx,4)
      void *stack = malloc(PGSIZE * 2);
  ...
  db:	ff 75 08             	push   0x8(%ebp)
      stack_addrs[i] = stack;
  de:	89 0c 9d c0 0e 00 00 	mov    %ecx,0xec0(,%ebx,4)
      return clone(start_routine,arg1,arg2,stack);
 ...
 118:	31 db                	xor    %ebx,%ebx
{
 ...
 145:	ff 34 9d c0 0d 00 00 	push   0xdc0(,%ebx,4)
 14c:	e8 bf 05 00 00       	call   710 <free>
      inUse[i] = 0;
      break;
 151:	83 c4 10             	add    $0x10,%esp
      inUse[i] = 0;
 154:	c7 04 9d c0 0c 00 00 	movl   $0x0,0xcc0(,%ebx,4)
 15b:	00 00 00 00 
    }
  }
  return id;
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 2c 09 00 00 	movzbl 0x92c(%edx),%edx
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e9:	ff 24 85 d4 08 00 00 	jmp    *0x8d4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba cb 08 00 00       	mov    $0x8cb,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 c0 0f 00 00       	mov    0xfc0,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 c0 0f 00 00    	mov    %edx,0xfc0
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 c0 0f 00 00    	mov    %edx,0xfc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d c0 0f 00 00    	mov    0xfc0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d c0 0f 00 00    	mov    0xfc0,%edi
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 c0 0f 00 00    	mov    0xfc0,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 c0 0f 00 00    	mov    %edx,0xfc0
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 c0 0f 00 00 c4 	movl   $0xfc4,0xfc0
 867:	0f 00 00 
    base.s.size = 0;
 86a:	bf c4 0f 00 00       	mov    $0xfc4,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 c4 0f 00 00 c4 	movl   $0xfc4,0xfc4
 876:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 c8 0f 00 00 00 	movl   $0x0,0xfc8
 882:	00 00 00 
    if(p->s.size >= nunits){
