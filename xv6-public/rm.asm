...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 39 04 00 00       	call   473 <unlink>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  87:	a1 a4 0c 00 00       	mov    0xca4,%eax
  ...
  94:	8b 0d a4 0c 00 00    	mov    0xca4,%ecx
 ...
 4ec:	89 d1                	mov    %edx,%ecx
{
 ...
 519:	0f b6 92 44 09 00 00 	movzbl 0x944(%edx),%edx
 ...
 599:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 609:	ff 24 85 ec 08 00 00 	jmp    *0x8ec(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 717:	90                   	nop
          s = "(null)";
 718:	ba e5 08 00 00       	mov    $0x8e5,%edx
        while(*s != 0){
