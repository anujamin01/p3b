...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 19 04 00 00       	call   453 <unlink>
  ...
  exit();
  4b:	e8 b3 03 00 00       	call   403 <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  53:	68 ac 08 00 00       	push   $0x8ac
  58:	6a 02                	push   $0x2
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2)
{
  ...
  87:	eb 0f                	jmp    98 <thread_create+0x18>
  89:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  90:	83 c3 01             	add    $0x1,%ebx
  93:	83 fb 40             	cmp    $0x40,%ebx
  96:	74 60                	je     f8 <thread_create+0x78>
    if (inUse[i] == 0){
  98:	8b 04 9d a0 0c 00 00 	mov    0xca0(,%ebx,4),%eax
  9f:	85 c0                	test   %eax,%eax
  a1:	75 ed                	jne    90 <thread_create+0x10>
      void *stack = malloc(PGSIZE * 2);
  a3:	a1 98 0c 00 00       	mov    0xc98,%eax
  a8:	83 ec 0c             	sub    $0xc,%esp
  ab:	01 c0                	add    %eax,%eax
  ad:	50                   	push   %eax
  ae:	e8 ed 06 00 00       	call   7a0 <malloc>
      malloc_addrs[i] = stack;
      // if page aligned
      if ((int)stack % PGSIZE == 0){
  b3:	8b 35 98 0c 00 00    	mov    0xc98,%esi
  b9:	83 c4 10             	add    $0x10,%esp
  bc:	99                   	cltd   
      malloc_addrs[i] = stack;
  bd:	89 04 9d a0 0d 00 00 	mov    %eax,0xda0(,%ebx,4)
      void *stack = malloc(PGSIZE * 2);
  c4:	89 c1                	mov    %eax,%ecx
      if ((int)stack % PGSIZE == 0){
  c6:	f7 fe                	idiv   %esi
        stack += PGSIZE;
  c8:	8d 04 31             	lea    (%ecx,%esi,1),%eax
  cb:	29 d6                	sub    %edx,%esi
  cd:	01 f1                	add    %esi,%ecx
  cf:	85 d2                	test   %edx,%edx
  d1:	0f 44 c8             	cmove  %eax,%ecx
  ...
  db:	ff 75 08             	push   0x8(%ebp)
      stack_addrs[i] = stack;
  de:	89 0c 9d a0 0e 00 00 	mov    %ecx,0xea0(,%ebx,4)
      return clone(start_routine,arg1,arg2,stack);
  e5:	e8 b9 03 00 00       	call   4a3 <clone>
  ...
  f8:	8d 65 f8             	lea    -0x8(%ebp),%esp
  return -1;
  fb:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
 100:	5b                   	pop    %ebx
 101:	5e                   	pop    %esi
 102:	5d                   	pop    %ebp
 ...
 118:	31 db                	xor    %ebx,%ebx
{
 11a:	83 ec 1c             	sub    $0x1c,%esp
  int id = join(&stackAddr);
 11d:	50                   	push   %eax
 11e:	e8 88 03 00 00       	call   4ab <join>
 ...
 136:	74 27                	je     15f <thread_join+0x4f>
    if (inUse[i] == 1){ // if joined free the stack 
 138:	83 3c 9d a0 0c 00 00 	cmpl   $0x1,0xca0(,%ebx,4)
 13f:	01 
 140:	75 ee                	jne    130 <thread_join+0x20>
      free(malloc_addrs[i]);
 142:	83 ec 0c             	sub    $0xc,%esp
 145:	ff 34 9d a0 0d 00 00 	push   0xda0(,%ebx,4)
 14c:	e8 bf 05 00 00       	call   710 <free>
      inUse[i] = 0;
      break;
 151:	83 c4 10             	add    $0x10,%esp
      inUse[i] = 0;
 154:	c7 04 9d a0 0c 00 00 	movl   $0x0,0xca0(,%ebx,4)
 15b:	00 00 00 00 
    }
  }
  return id;
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 24 09 00 00 	movzbl 0x924(%edx),%edx
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e9:	ff 24 85 cc 08 00 00 	jmp    *0x8cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba c5 08 00 00       	mov    $0x8c5,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 a0 0f 00 00       	mov    0xfa0,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 a0 0f 00 00    	mov    %edx,0xfa0
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 a0 0f 00 00    	mov    %edx,0xfa0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d a0 0f 00 00    	mov    0xfa0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d a0 0f 00 00    	mov    0xfa0,%edi
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 a0 0f 00 00    	mov    0xfa0,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 a0 0f 00 00    	mov    %edx,0xfa0
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 a0 0f 00 00 a4 	movl   $0xfa4,0xfa0
 867:	0f 00 00 
    base.s.size = 0;
 86a:	bf a4 0f 00 00       	mov    $0xfa4,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 a4 0f 00 00 a4 	movl   $0xfa4,0xfa4
 876:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 a8 0f 00 00 00 	movl   $0x0,0xfa8
 882:	00 00 00 
    if(p->s.size >= nunits){
